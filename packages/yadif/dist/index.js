...
`;
function R(i, e, t) {
  const A = i.createProgram(), s = G(i, i.VERTEX_SHADER, t), r = G(i, i.FRAGMENT_SHADER, e);
  if (i.attachShader(A, s), i.attachShader(A, r), i.linkProgram(A), i.deleteShader(s), i.deleteShader(r), !i.getProgramParameter(A, i.LINK_STATUS)) {
    const n = i.getProgramInfoLog(A);
    throw i.deleteProgram(A), new Error(
...
function G(i, e, t) {
  ...
  if (i.shaderSource(A, t), i.compileShader(A), !i.getShaderParameter(A, i.COMPILE_STATUS)) {
    const s = i.getShaderInfoLog(A);
    throw i.deleteShader(A), new Error(
...
`;
function J(i, e) {
  const t = R(i, Y, j), A = i.getAttribLocation(t, "aVertexPosition"), s = i.getAttribLocation(t, "aTextureCoord"), r = i.getUniformLocation(t, "uTexture"), n = i.getUniformLocation(t, "uMatrix"), a = i.getUniformLocation(t, "uUvMatrix"), h = i.getUniformLocation(t, "uTextColor"), c = i.getUniformLocation(t, "uBackColor");
  if (r == null || n == null || a == null || h == null || c == null)
    throw new Error(
      "failed to initialize DEBUG_FRAGMENT_SHADER, DEBUG_VERTEX_SHADER"
    );
  const o = i.createBuffer(), l = i.createBuffer();
  return {
    gl: i,
    ...K(i, e),
    program: t,
...
function K(i, e) {
  const t = new OffscreenCanvas(0, 0), A = t.getContext("2d"), s = /* @__PURE__ */ new Map();
  let r = 0;
  const n = 0;
  let a = 1;
  ...
  return i.bindTexture(i.TEXTURE_2D, h), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MIN_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MAG_FILTER, i.LINEAR), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE), i.texImage2D(i.TEXTURE_2D, 0, i.RGBA, i.RGBA, i.UNSIGNED_BYTE, t), { fontTexture: h, chars: s, textureSize: { width: r, height: a } };
}
function q(i) {
  const e = i.gl;
  e.deleteBuffer(i.positionBuffer), e.deleteBuffer(i.textureBuffer), e.deleteTexture(i.fontTexture), e.deleteProgram(i.program);
}
function ee(i, e, t, A, s, r, n) {
  const a = [], h = [], c = t;
  for (const d of e) {
    if (d === `
`) {
  ...
  const o = i.gl;
  o.useProgram(i.program), o.bindBuffer(o.ARRAY_BUFFER, i.positionBuffer), o.bufferData(o.ARRAY_BUFFER, new Float32Array(a), o.STATIC_DRAW), o.vertexAttribPointer(
    i.programUniforms.vertex,
    2,
    o.FLOAT,
    !1,
    0,
    0
  ), o.enableVertexAttribArray(i.programUniforms.vertex), o.bindBuffer(o.ARRAY_BUFFER, i.textureBuffer), o.bufferData(
    o.ARRAY_BUFFER,
    new Float32Array(h),
    o.STATIC_DRAW
  ), o.vertexAttribPointer(
    i.programUniforms.textureCoord,
    2,
    o.FLOAT,
    !1,
    0,
    0
  ), o.enableVertexAttribArray(i.programUniforms.textureCoord), o.activeTexture(o.TEXTURE0), o.bindTexture(o.TEXTURE_2D, i.fontTexture), o.uniform1i(i.programUniforms.texture, 0), o.uniform3fv(i.programUniforms.textColor, [1, 1, 1]), o.uniform3fv(i.programUniforms.backColor, [0, 0, 0]);
  function l(d, u, m) {
    const E = [];
    for (let T = 0; T < u; T++)
      for (let v = 0; v < d; v++)
  ...
  o.uniformMatrix4fv(i.programUniforms.matrix, !1, l(4, 4, [
    1 / (s / 2),
    0,
    0,
    -1,
    ...
    0,
    1
  ])), o.uniformMatrix3fv(i.programUniforms.uvMatrix, !1, l(3, 3, [
    1 / i.textureSize.width,
    0,
    0,
    0,
    1 / i.textureSize.height,
    0,
    0,
    0,
    1
  ])), o.viewport(0, 0, s, r), o.enable(o.BLEND), o.blendFunc(o.SRC_ALPHA, o.ONE_MINUS_SRC_ALPHA), o.drawArrays(o.TRIANGLES, 0, a.length / 2), o.disable(o.BLEND);
}
const f = {
...
function fe(i, e) {
  return i ? "film" : e ? "field" : "frame";
}
function de(i, e) {
  return i.phase === 0 || e > L ? null : {
    phase: (i.phase - 1 + e) % L + 1,
    run: i.run
  };
}
function pe(i) {
...
function me(i, e, t) {
  const A = t * L / ue, s = le[i] ?? 0;
  return { at: e + s * t, duration: A };
}
const D = { phase: 0, run: 0 };
function S(i, e, t) {
  return Object.fromEntries(
    Object.entries(t).map(([A, s]) => [
      A,
      i.getUniformLocation(e, s)
    ])
  );
}
class Ee {
  ...
  get texture() {
    return this.#r?.[this.#p]?.textures[0] ?? null;
  }
  ...
  reset() {
    ...
    const t = this.#r?.[this.#p];
    if (!t) return;
    const A = new Float32Array(w * 4);
    for (let s = 0; s < f.phase; s++)
      A[s * 4 + 1] = 1;
  ...
  detect(e, t, A) {
    ...
    const h = a[this.#p], c = a[1 - this.#p];
    s.bindFramebuffer(s.FRAMEBUFFER, r.framebuffer), s.useProgram(this.#A), this.#o(0, e, this.#n.a), this.#o(1, t, this.#n.b), this.#o(2, h.textures[0], this.#n.fieldMetrics), s.uniform1i(this.#n.first, A), s.uniform2i(this.#n.size, this.#t, this.#h), s.viewport(0, 0, r.width, r.height), s.drawArrays(s.TRIANGLES, 0, 3), s.bindFramebuffer(s.FRAMEBUFFER, n.framebuffer), s.useProgram(this.#b), this.#o(0, r.textures[0], this.#i.second), this.#o(1, r.textures[1], this.#i.first), s.uniform2i(this.#i.size, r.width, r.height), s.viewport(0, 0, n.width, n.height), s.drawArrays(s.TRIANGLES, 0, 3), s.bindFramebuffer(s.FRAMEBUFFER, c.framebuffer), s.useProgram(this.#w), this.#o(0, h.textures[0], this.#F.previous), this.#o(1, n.textures[0], this.#F.second), this.#o(2, n.textures[1], this.#F.first), s.uniform2i(this.#F.size, n.width, n.height), s.viewport(0, 0, w, 1), s.drawArrays(s.TRIANGLES, 0, 3), this.#p = 1 - this.#p, s.deleteSync(this.#f), s.bindBuffer(s.PIXEL_PACK_BUFFER, this.#m), s.readPixels(0, 0, w, 1, s.RGBA, s.FLOAT, 0), s.bindBuffer(s.PIXEL_PACK_BUFFER, null), s.bindFramebuffer(s.FRAMEBUFFER, null), this.#f = s.fenceSync(s.SYNC_GPU_COMMANDS_COMPLETE, 0), s.flush();
  }
  /**
  ...
  poll() {
    ...
    if (t === null || this.#m === null) return null;
    switch (e.clientWaitSync(t, 0, 0)) {
      case e.ALREADY_SIGNALED:
      case e.CONDITION_SATISFIED:
        return e.bindBuffer(e.PIXEL_PACK_BUFFER, this.#m), e.getBufferSubData(e.PIXEL_PACK_BUFFER, 0, this.metrics), e.bindBuffer(e.PIXEL_PACK_BUFFER, null), e.deleteSync(t), this.#f = null, {
  ...
  destroy() {
    ...
    e.deleteSync(this.#f), this.#f = null, e.deleteBuffer(this.#m), this.#m = null, e.deleteProgram(this.#A), e.deleteProgram(this.#b), e.deleteProgram(this.#w);
  }
  #o(e, t, A) {
    const s = this.#e;
    s.activeTexture(s.TEXTURE0 + e), s.bindTexture(s.TEXTURE_2D, t ?? null), s.uniform1i(A, e);
  }
  #x() {
    const e = this.#e;
  ...
  #ee() {
    ...
    this.#r === null && (this.#r = [
      _(e, w, 1, 1),
      _(e, w, 1, 1)
    ], this.#p = 0, this.reset()), this.#m === null && (this.#m = e.createBuffer(), e.bindBuffer(e.PIXEL_PACK_BUFFER, this.#m), e.bufferData(
      e.PIXEL_PACK_BUFFER,
...
function _(i, e, t, A) {
  ...
  for (let h = 0; h < A; h++) {
    ...
    i.bindTexture(i.TEXTURE_2D, c), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MIN_FILTER, i.NEAREST), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MAG_FILTER, i.NEAREST), i.texImage2D(
      i.TEXTURE_2D,
      0,
      i.RGBA32F,
      e,
  ...
  i.drawBuffers(r.map((h, c) => i.COLOR_ATTACHMENT0 + c));
  const n = i.checkFramebufferStatus(i.FRAMEBUFFER) === i.FRAMEBUFFER_COMPLETE;
  i.bindFramebuffer(i.FRAMEBUFFER, null);
  const a = { framebuffer: s, textures: r, width: e, height: t };
  if (!n)
    throw y(i, a), new Error("failed to allocate framebuffer");
  return a;
}
function y(i, { framebuffer: e, textures: t }) {
  i.deleteFramebuffer(e);
  for (const A of t) i.deleteTexture(A);
}
const ve = 1e3;
function we(i, e) {
  return typeof i != "number" || !(i > 0) || !Number.isFinite(i) || Math.abs(i - e) >= ve ? e : i;
}
function N(i) {
...
const Te = 0.5, p = 4, x = 5, k = 1e3, De = 4, P = 200, be = 0.25, Re = 0.75, Fe = 0.1, X = 1, ge = 1e3 / 60, _e = 0.02, ye = 0.1, O = 1, Me = `#version 300 es
precision highp float;
...
class ke {
  ...
  constructor(e, t = {}) {
    ...
    this.#A = A, this.#n = new Ee(A), this.#b = R(A, ce, F);
    const s = this.#b;
    ...
    ), this.#w = R(A, Me, F), this.#F = A.getUniformLocation(this.#w, "uField"), this.#R = A.getUniformLocation(this.#w, "uFlip"), this.#_ && this.#ge(), this.#G = A.getExtension(
  ...
  get running() {
    return this.#D && (this.#c?.interlaced ?? !0);
  }
  ...
  set videoTimeline(e) {
    this.#Q = e, e.length === 0 && (this.#c = null), this.#me();
  }
  get videoTimeline() {
    return this.#Q;
  }
  ...
  set film(e) {
    e !== this.#_ && (e && this.#ge(), this.#_ = e, e || (this.#O = !1, this.#v = D, this.#W()), this.#Fe());
  }
  get debug() {
    return this.#M;
  }
  ...
  #Fe() {
    this.#z ? (this.#l > 0 && this.#Le(), this.#ve()) : (this.#we(), this.#q());
  }
  #ge() {
  ...
  #me() {
    this.#le && (this.#Q.length > 0 || (this.#c?.interlaced ?? !0)) ? this.start() : this.stop();
  }
  start() {
    this.#D || this.#B || (this.#D = !0, this.#Ge(), this.#qe(), this.#oe(), (this.#c?.interlaced ?? !0) && this.#ve());
  }
  /** Take the deinterlaced picture away, leaving the element's own showing. */
  stop() {
    this.#D && (this.#D = !1, this.#I !== null && this.#e.cancelVideoFrameCallback(this.#I), this.#I = null, this.#we(), this.#a = 0, this.canvas.style.visibility = "hidden");
  }
  destroy() {
    ...
    this.#se.length = 0, this.#N.length = 0, this.#n.destroy(), this.#H !== null && (q(this.#H), this.#H = null), this.#A.deleteProgram(this.#b), this.#A.deleteProgram(this.#w), this.#A.getExtension("WEBGL_lose_context")?.loseContext();
  }
  #oe() {
    !this.#D || this.#I !== null || (this.#I = this.#e.requestVideoFrameCallback(this.#ze));
  }
  #ke(e, t, A) {
    this.#H == null && (this.#H = J(this.#A, "20px monospace")), ee(this.#H, e, t, A, this.#l, this.#T, 20);
  }
  #_e(e) {
    ...
    this.#G != null && (e != null && this.#A.endQuery(this.#G.TIME_ELAPSED_EXT), this.#N = this.#N.filter(
      ({ q: t, isField: A }) => {
        if (this.#A.getQueryParameter(t, this.#A.QUERY_RESULT_AVAILABLE)) {
          const s = this.#A.getQueryParameter(t, this.#A.QUERY_RESULT);
          return A ? (this.#j += s, this.#X++) : (this.#Y += s, this.#k++), this.#se.push(t), !1;
        }
        return !0;
      }
    ));
  ...
  #W() {
    this.#v = D, this.#J = D, this.#K = 0, this.#O = !1, this.#n.reset();
  }
  /** Detect the pulldown phase of the frame being filtered on the GPU. */
  #Xe() {
    const { cur: e, next: t } = this.#Pe(!1), A = this.#s[e], s = this.#s[t];
    if (!A || !s) return;
    const r = this.#c?.topFieldFirst !== !1 ? 0 : 1;
    this.#n.detect(A, s, r);
  }
  /**
  ...
  #Oe() {
    const e = this.#n.poll();
    e !== null && (this.#J = e, this.#K = 0), this.#K++;
    const t = de(this.#J, this.#K);
    this.#v = t ?? D;
  }
  #He(e) {
    ...
    const s = this.#re.map((r, n) => `${n === 0 ? "-" : n}:${r}`).join(" ");
    return `frame=${e} phase=${this.#v.phase} run=${this.#v.run} known=${this.#J.phase}/${this.#J.run} age=${this.#K} ${this.#O ? "film" : "video"} period=${this.#u.toFixed(3)}
${t.join(" ")}
${s} dropped:${this.#pe}`;
  }
  #ze = (e, t) => {
    if (this.#I = null, !(!this.#D || this.#B)) {
      if (this.#We(t.mediaTime), t.width > 0 && t.height > 0) {
        if ((this.#l === 0 || this.#T === 0) && this.#Ce(t.width, t.height), this.#c && !this.#c.interlaced) {
          this.#je(), this.#oe();
          return;
        }
        const A = t.mediaTime - this.#te, s = A < 0 || A > Te;
        s && (this.#a = 0, this.#E.discontinuities++, this.#t.length = 0, this.#h = null, this.#W());
        const r = this.#Je(t.presentedFrames, s);
        if (this.#a > 0 && t.mediaTime === this.#te) {
          this.#oe();
          return;
        }
        !s && A > 0 && this.#Ze(A), this.#te = t.mediaTime;
        const n = performance.now();
        n - this.#de > k && (this.#ie = n, this.#S = 0, this.#$ = 0, this.#P = 0, this.#V = 0, this.#U = 0, this.#Y = 0, this.#k = 0, this.#j = 0, this.#X = 0), this.#de = n;
        const a = performance.now(), h = this.#_e(!1);
        if (this.#Se(), this.#U = Math.max(
          this.#U,
          this.#t.length
        ), this.#_ && (this.#a === p && r === 0 ? (this.#Oe(), this.#Xe()) : this.#W(), this.#re[this.#v.phase] = (this.#re[this.#v.phase] ?? 0) + 1, this.#O = this.#v.phase !== 0 && this.#v.run >= Q, this.#M && (this.#Re = this.#He(t.presentedFrames))), this.#Me()) {
          this.#t.length >= x && (this.#t.length = 0, this.#h = null, this.#E.queueResetted++);
          const c = we(t.expectedDisplayTime, e) + this.#g;
          switch (fe(this.#O, this.#L)) {
            case "film": {
              const o = this.#v.phase;
              if (pe(o))
                this.#pe++, this.#ce++;
              else {
                const { at: l, duration: d } = me(
                  o,
                  c,
                  this.#u
                ), u = this.#Ee("film", l, d);
                this.#ne("film", o, !1, u, d);
              }
              break;
            }
            case "field": {
              const o = this.#u / 2, l = this.#Ee("field", c, o);
              this.#ne("field", 1, !1, l, o), this.#ne("field", 2, !0, l + o, o);
              break;
            }
            default: {
              const o = this.#u, l = this.#Ee("frame", c, o);
              this.#ne("frame", 0, !1, l, o);
            }
          }
        } else
          this.#Te(!1, !1, null);
        this.#ye(h), this.#$ += performance.now() - a, this.#S++, this.#Ke(n);
      }
      this.#oe();
    }
  };
  #We(e) {
    ...
    const A = t?.scan;
    !A || this.#c?.interlaced === A.interlaced && this.#c.topFieldFirst === A.topFieldFirst || (this.#c = A, this.#a = 0, this.#t.length = 0, this.#h = null, this.#W(), A.interlaced ? this.#z && this.#ve() : this.#we());
  }
  /**
   ...
   */
  #Me() {
    return this.#z && this.#u > 0 && this.#r.length === x;
  }
  /**
  ...
  #Ee(e, t, A) {
    ...
    s !== null && this.#E.resynced++;
    for (let r = this.#t.at(-1); r && r.at >= t; )
      this.#t.pop(), this.#E.late++, r = this.#t.at(-1);
    return t;
  }
  /**
   ...
   */
  #Ze(e) {
    const t = e * 1e3 / (this.#e.playbackRate || 1), A = this.#u > 0 ? Math.max(1, Math.round(t / this.#u)) : 1, s = t / A;
    s < De || s > P || (this.#u = this.#u > 0 && s > this.#u * Re ? this.#u + (s - this.#u) * be : s);
  }
  /**
  ...
  #ve() {
    this.#o === null && (!this.#D || this.#B || !this.#z || (this.#x = N(this.canvas), this.#o = this.#x.requestAnimationFrame(this.#Be)));
  }
  #we() {
    this.#o !== null && this.#x.cancelAnimationFrame(this.#o), this.#o = null, this.#x = window, this.#t.length = 0, this.#h = null;
  }
  #Be = (e) => {
    this.#o = null, !(!this.#D || this.#B || !this.#z) && (this.#x = N(this.canvas), this.#Qe(e), this.#$e(this.#Z, e), this.#o = this.#x.requestAnimationFrame(this.#Be));
  };
  /**
  ...
  #Qe(e) {
    const t = e - this.#ee;
    this.#ee = e;
    const A = Math.max(1, Math.round(t / this.#g)), s = this.#Z + A * this.#g, r = e - s;
    if (this.#Z === 0 || t <= 0 || t > P || Math.abs(r) > this.#g / 4) {
      t > 0 && t <= P && (this.#g = t), this.#Z = e;
      return;
    }
    this.#g += r / A * _e, this.#Z = s + r * ye;
  }
  /**
   ...
   */
  #$e(e, t) {
    const A = this.#g / 2, s = (h) => {
      const c = h.at - e;
      return c <= A - O ? !0 : c > A + O ? !1 : this.#De > 0;
    };
    for (; this.#t[1] && s(this.#t[1]); )
      this.#E.late++, this.#t.shift();
    const r = this.#t[0];
    if (!r || !s(r)) return;
    this.#t.shift(), this.#De = r.at - e;
    const n = performance.now(), a = this.#_e(!0);
    this.#Ye(r.slot), this.#ye(a), this.#V += performance.now() - n, this.#P++, this.#M && this.#Ve(r, t), this.#ae = t;
  }
  #Ve(e, t) {
    const A = this.#ae === 0 ? 0 : t - this.#ae, s = A / this.#g, r = e.cadence === "film" ? `phase ${e.phase}` : e.cadence === "field" ? `field ${e.phase}` : "frame", n = e.droppedBefore > 0 ? `, phase ${U} dropped before it` + (e.droppedBefore > 1 ? ` (${e.droppedBefore})` : "") : "";
    console.log(
      `yadif: +${A.toFixed(2)} ms (${s.toFixed(2)} refreshes) ${e.cadence} ${r}, due ${(e.at - t).toFixed(2)} ms${n}`
    );
  }
  ...
  #je() {
    ...
    e && this.#xe(e, !0), this.#a = 0;
  }
  #xe(e, t = !1) {
    const A = this.#A;
    A.bindFramebuffer(A.FRAMEBUFFER, null), A.useProgram(this.#w), A.activeTexture(A.TEXTURE0), A.bindTexture(A.TEXTURE_2D, e), A.uniform1i(this.#F, 0), A.uniform1i(this.#R, t ? 1 : 0), A.viewport(0, 0, this.#l, this.#T), A.drawArrays(A.TRIANGLES, 0, 3), this.#p = e, this.#m = t, this.canvas.style.visibility = "visible";
  }
  /**
   ...
   */
  capture() {
    if (this.#B || this.#l === 0 || this.#p === null)
      return Promise.reject(
        new Error("the deinterlacer has no picture to capture")
      );
    this.#xe(this.#p, this.#m);
    const { width: e, height: t } = xe(
      this.#e.videoWidth,
      this.#e.videoHeight,
      this.#l,
      this.#T
    ...
    return s === null ? createImageBitmap(this.canvas) : (s.drawImage(this.canvas, 0, 0, e, t), createImageBitmap(A));
  }
  /**
  ...
  #Je(e, t) {
    let A = 0;
    return this.#Ae !== 0 && !t && (A = Math.max(0, e - this.#Ae - 1), this.#E.missed += A), this.#Ae = e, A;
  }
  #Ke(e) {
    if (!this.#fe) return;
    const t = e - this.#ie;
    ...
    let s = 0;
    this.#S !== 0 && (s += this.#$ / this.#S), this.#P !== 0 && (s += this.#V / this.#P / 2);
    let r;
    this.#G != null && (r = 0, this.#k !== 0 && (r += this.#Y / 1e6 / this.#k), this.#X !== 0 && (r += this.#j / 1e6 / this.#X / 2)), this.#fe({
      ...this.#E,
      ...
      gpuMs: r,
      film: this.#O
    }), this.#ie = e, this.#S = 0, this.#$ = 0, this.#P = 0, this.#V = 0, this.#U = 0, this.#Y = 0, this.#k = 0, this.#j = 0, this.#X = 0;
  }
  ...
  #Te(e, t, A) {
    ...
    this.#a === p && !e ? this.#E.filtered++ : this.#E.degraded++;
    const s = this.#A, { prev: r, cur: n, next: a } = this.#Pe(e);
    s.bindFramebuffer(s.FRAMEBUFFER, A), s.useProgram(this.#b);
    for (const [l, d] of [r, n, a].entries())
      s.activeTexture(s.TEXTURE0 + l), s.bindTexture(s.TEXTURE_2D, this.#s[d] ?? null);
    s.uniform1i(this.#i.prev, 0), s.uniform1i(this.#i.cur, 1), s.uniform1i(this.#i.next, 2);
    const h = this.#_ ? this.#n.texture : null, c = h !== null;
    h !== null && (s.activeTexture(s.TEXTURE0 + 3), s.bindTexture(s.TEXTURE_2D, h), s.uniform1i(this.#i.fieldMetrics, 3)), s.uniform2i(this.#i.size, this.#l, this.#T);
    const o = this.#c?.topFieldFirst !== !1 ? 0 : 1;
    s.uniform1i(this.#i.parity, t ? 1 - o : o), s.uniform1i(this.#i.second, t ? 1 : 0), s.uniform1i(
      this.#i.tff,
      this.#c?.topFieldFirst !== !1 ? 1 : 0
    ), s.uniform1i(this.#i.spatialCheck, this.#be ? 1 : 0), s.uniform1i(this.#i.debug, this.#M ? 1 : 0), s.uniform1i(this.#i.film, c ? 1 : 0), s.uniform1i(this.#i.phase, this.#v.phase), s.viewport(0, 0, this.#l, this.#T), s.drawArrays(s.TRIANGLES, 0, 3), this.#M && c && this.#ke(this.#Re, 0, 90), A === null && (this.canvas.style.visibility = "visible");
  }
  #Pe(e) {
    const t = (A) => (this.#d + p - A) % p;
    return this.#a === 1 ? { prev: this.#d, cur: this.#d, next: this.#d } : e ? { prev: t(1), cur: this.#d, next: this.#d } : this.#a === 2 ? { prev: t(1), cur: t(1), next: this.#d } : { prev: t(2), cur: t(1), next: this.#d };
  }
  /**
  ...
  #Ce(e, t) {
    const A = this.#A;
    this.canvas.width = e, this.canvas.height = t, this.#l = e, this.#T = t, this.#a = 0, this.#he();
    for (const s of this.#s) A.deleteTexture(s);
    this.#s = [];
    for (let s = 0; s < p; s++) {
    ...
    this.#q(), this.#n.resize(e, t), this.#z && this.#Le();
  }
  /**
    ...
    if (!(this.#r.length === x || this.#l === 0)) {
      ...
      for (let t = 0; t < x; t++) {
        ...
        if (e.bindFramebuffer(e.FRAMEBUFFER, null), !r) {
          e.deleteFramebuffer(s), e.deleteTexture(A), this.#q();
          return;
        }
        this.#r.push({ texture: A, framebuffer: s });
      }
      this.#f = x - 1;
    }
  }
  ...
  #Ie = () => this.#he();
  #Ue = () => {
    this.#a = 0, this.#te = 0, this.#t.length = 0, this.#h = null, this.#W(), this.#u = 0, this.#Ge(), this.canvas.style.visibility = "hidden";
  };
  #Ge() {
    this.#E = {
      filtered: 0,
      ...
      resynced: 0,
      queueResetted: 0
    }, this.#re.fill(0), this.#pe = 0, this.#Ae = 0, this.#ie = 0, this.#de = 0, this.#S = 0, this.#$ = 0, this.#P = 0, this.#V = 0, this.#U = 0, this.#Y = 0, this.#k = 0, this.#j = 0, this.#X = 0;
  }
  /**
   ...
   */
  #y = () => {
    this.#t.length = 0, this.#h = null, this.#W(), this.#D && this.#Te(!0, !1, null);
  };
  /**
...
async function Ce(i) {
  ...
  try {
    ...
    if (await n.ready, await a, await Ue(r, t, await h), r.videoWidth === 0 || r.videoHeight === 0)
...
const C = typeof MediaSource > "u" ? globalThis.ManagedMediaSource : MediaSource, Le = typeof MediaSource > "u";
function Ie(i, e) {
  if (!C || !C.isTypeSupported(W))
    throw new Error("the probe clip needs Media Source Extensions");
  const t = H.indexOf(","), A = atob(H.slice(t + 1)), s = new Uint8Array(A.length);
  for (let h = 0; h < A.length; h++) s[h] = A.charCodeAt(h);
  const r = new C(), n = URL.createObjectURL(r);
  if (Le) {
    i.disableRemotePlayback = !0;
    const h = document.createElement("source");
    h.type = "video/mp4", h.src = n, i.append(h), i.load();
  } else
    i.src = n;
  const a = (async () => {
    await B(M(r, "sourceopen"), e);
    const h = r.addSourceBuffer(W), c = B(M(h, "updateend"), e);
    h.appendBuffer(s), await c, r.endOfStream();
  })();
...
async function Ue(i, e, t) {
  if (t) {
    ...
    for (; i.currentTime < z && performance.now() - A < e; )
      await new Promise((s) => requestAnimationFrame(s));
    i.pause();
  } else
    i.currentTime = z, await B(M(i, "seeked"), e);
}
function Ge(i) {
  const e = i.videoHeight, t = document.createElement("canvas");
  ...
  A.imageSmoothingEnabled = !1, A.drawImage(i, 0, 0, b, e);
  const s = A.getImageData(0, 0, b, e).data, r = (o) => {
    let l = 0;
    for (let d = 0; d < b; d++)
      l += s[(o * b + d) * 4 + 1] ?? 0;
    return l / b;
...
function M(i, e) {
  return new Promise((t, A) => {
    i.addEventListener(e, () => t(), { once: !0 }), i.addEventListener(
      "error",
      () => {
        const s = i instanceof HTMLMediaElement ? i.error : null, r = s ? ` (MediaError ${s.code}${s.message ? `: ${s.message}` : ""})` : "";
...
export {
  ...
  Oe as forgetDecoderProbe,
  Pe as probeDecoder,
  Ne as supportsDeinterlace
};
