...
`;class Ee extends EventTarget{#n;#i;#e;#s;#x;#a;#T;#O;#z;#w=null;#ce=null;#L=null;#fe=null;#J=null;#je=null;#_=null;#F=[];#g=[];#Z=L-1;#d=null;#t=[];#P=null;#ue=0;#U=null;#W=ue;#H=null;#Fe;#R;#m;#X;#Re;#S="video";#ee="c";#Me=0;#ke=!0;#Se=new y(M,k);#Ae=1/0;#De=1/0;#I=0;#f=0;#p=0;#y=0;#v=T-1;#o=0;#G=0;#te=!1;#Y=null;#de=0;#q=0;#Ce=0;#u=!1;#we=!1;#l=null;#V=[];#M=!1;#Le;#c;#me;#A;#_e;#h=null;#r;#ie=!1;#Pe=0;#Ue=!1;#pt=0;#se=!1;#pe=!1;#j=null;#vt=0;#re=new Map;#E={filtered:0,missed:0,degraded:0,discontinuities:0,late:0,queueResetted:0};#B=0;#Ie=0;#ve=0;#N=0;#ne=0;#he=0;#ae=0;#Q=0;constructor(e,t={},i=null){super(),this.#e=e,this.#R=t.doubleRate??!1,this.#m=t.autoFilm??!1,this.#X=Z(t.filmCombThreshold??y.COMBED_PIXEL_LIMIT),this.#Re=t.spatialCheck??!0,this.#Le=t.onStats,this.#c=i,this.#A=i?"main":t.rendering??"auto",this.#_e=t.workerUrl??le,this.#r=this.#A==="main"?"main":"idle",this.#i=i?i.canvas:document.createElement("canvas"),this.#n=i?.canvas??(this.#A==="main"?this.#i:document.createElement("canvas")),this.#me=e,i||(this.#i.style.cssText="position:absolute;pointer-events:none;visibility:hidden");const s=this.#n.getContext("webgl2",{alpha:!1,antialias:!1,depth:!1,stencil:!1,preserveDrawingBuffer:!1,powerPreference:"high-performance"});if(!s)throw new Error("this browser has no WebGL2");this.#s=s,this.#x=O(s,ne);const r=this.#x;this.#a=Object.fromEntries(Object.entries(re).map(([n,o])=>[n,s.getUniformLocation(r,o)])),this.#T=O(s,ge),this.#O=s.getUniformLocation(this.#T,"uField"),this.#z=s.getUniformLocation(this.#T,"uFlip"),this.#m&&this.#et(),this.#n.addEventListener("webglcontextlost",this.#mt),this.#Fe=i?null:new ResizeObserver(()=>this.#Te()),e.addEventListener("emptied",this.#ft),e.addEventListener("resize",this.#ct),e.addEventListener("pause",this.#C),e.addEventListener("ended",this.#C),e.addEventListener("seeking",this.#dt),e.addEventListener("seeked",this.#C),e.addEventListener("ratechange",this.#C)}get running(){return this.#u&&(this.#l?.interlaced??!0)}get canvas(){return this.#i}get#ge(){return this.#l?.topFieldFirst!==!1}#Qe(){return{doubleRate:this.#R,autoFilm:this.#m,filmCombThreshold:this.#X,spatialCheck:this.#Re}}get enabled(){return this.#we}set enabled(e){this.#we=e,this.#Ne(),this.#h?.postMessage({type:"enabled",enabled:e})}set scan(e){const t=this.#l?.interlaced!==e?.interlaced,i=t||this.#l?.topFieldFirst!==e?.topFieldFirst;this.#l=e,this.#h?.postMessage({type:"scan",scan:e}),i&&(this.#o=0,this.#b(),t&&(this.#f=0),this.#d=null,this.#k(!1)),this.#Ne(),i&&((e?.interlaced??!0)&&(this.#c||this.#r==="main")?this.#$():this.#He())}get scan(){return this.#l}set videoTimeline(e){this.#V=e,this.#h?.postMessage({type:"timeline",videoTimeline:e}),e.length===0&&(this.#l=null),this.#Ne()}get videoTimeline(){return this.#V}get container(){return this.#H??this.#e}get doubleRate(){return this.#R}set doubleRate(e){e!==this.#R&&(this.#R=e,this.#Be(),this.#t.length=0,e?(this.#p>0&&this.#qe(),(this.#l?.interlaced??!0)&&(this.#c||this.#r==="main")&&this.#$()):this.#m||(this.#d=null,this.#k(!1),this.#K()))}get autoFilm(){return this.#m}set autoFilm(e){e!==this.#m&&(this.#m=e,this.#Be(),this.#b(),e?(this.#et(),this.#p>0&&(this.#lt(),this.#qe()),(this.#l?.interlaced??!0)&&(this.#c||this.#r==="main")&&this.#$()):(this.#Ye(),this.#R||(this.#d=null,this.#k(!1),this.#K())))}get filmCombThreshold(){return this.#X}set filmCombThreshold(e){const t=Z(e);t!==this.#X&&(this.#X=t,this.#Be(),this.#m&&this.#b())}#Be(){this.#h?.postMessage({type:"settings",options:this.#Qe()})}#Ne(){this.#we&&(this.#V.length>0||(this.#l?.interlaced??!0))?this.start():this.stop()}#gt(){return this.#c||this.#A==="main"?!1:this.#r==="starting"||this.#r==="active"?!0:typeof Worker<"u"&&typeof VideoFrame<"u"&&typeof OffscreenCanvas<"u"&&this.#_e!==null&&"transferControlToOffscreen"in HTMLCanvasElement.prototype?(this.#$e(),!0):this.#A==="auto"?(this.#Ee(),!1):(this.#r="failed",this.#u=!1,!0)}#$e(){this.#D(),this.#h?.terminate(),this.#h=null,this.#se=!1,this.#pe=!1;let e=this.#i;if(this.#Ue){e=document.createElement("canvas"),e.className=this.#i.className;const r=this.#i.getAttribute("style");r===null?e.removeAttribute("style"):e.setAttribute("style",r),e.style.visibility="hidden",this.#i.parentElement&&this.#i.replaceWith(e),this.#i=e}const t=++this.#Pe;this.#r="starting";let i,s;try{s=e.transferControlToOffscreen(),this.#Ue=!0,i=new Worker(this.#_e,{type:"module"})}catch(r){this.#oe(r instanceof Error?r.message:String(r));return}this.#h=i,i.onmessage=r=>{t===this.#Pe&&this.#Et(r.data)},i.onerror=r=>{t===this.#Pe&&(r.preventDefault(),this.#oe(r.message||"the deinterlacer worker failed"))},i.postMessage({type:"initialize",canvas:s,options:this.#Qe(),scan:this.#l,videoTimeline:this.#V,enabled:this.#u,video:this.#Oe()},[s])}#Et(e){switch(e.type){case"ready":this.#r="active",this.#u&&(this.#be(),this.#Xe());break;case"failed":this.#oe(e.message);break;case"consumed":{this.#se=!1,this.#pe=!0;const t=this.#j;this.#j=null,t&&this.#Je(t);break}case"visibility":this.#i.style.visibility=e.visible?"visible":"hidden";break;case"stats":{const t={...e.stats,dropped:this.#e.getVideoPlaybackQuality?.().droppedVideoFrames??0};this.dispatchEvent(new CustomEvent("stats",{detail:t})),this.#Le?.(t);break}case"capture":{const t=this.#re.get(e.id);if(this.#re.delete(e.id),!t){e.image?.close();break}e.image?t.resolve(e.image):createImageBitmap(this.#e).then(t.resolve,t.reject);break}}}#oe(e){if(this.#r==="starting"&&this.#A==="auto"&&!this.#ie){this.#Ee();return}if(this.#Ke(e),!this.#ie){this.#ie=!0,this.#$e();return}console.error(`Deinterlacer Worker stopped: ${e}`),this.#r="failed",this.#h?.terminate(),this.#h=null,this.#D(),this.stop()}#Ee(){const e=this.#n;e.className=this.#i.className;const t=this.#i.getAttribute("style");t===null?e.removeAttribute("style"):e.setAttribute("style",t),e.style.visibility="hidden",this.#i.parentElement&&this.#i.replaceWith(e),this.#i=e,this.#Ue=!1,this.#h?.terminate(),this.#h=null,this.#r="main",this.#D(),this.#u&&(this.#be(),this.#Xe(),(this.#l?.interlaced??!0)&&this.#$())}#D(){this.#j?.frame.close(),this.#j=null}#Ke(e){for(const t of this.#re.values())t.reject(new Error(e));this.#re.clear()}start(){if(!(this.#u||this.#M)){if(this.#u=!0,this.#ut(),this.#b(),this.#de=performance.now(),this.#Ce=this.#de,this.#q=this.#e.getVideoPlaybackQuality?.().totalVideoFrames??0,this.#Lt(),this.#Xe(),this.#gt()){this.#h?.postMessage({type:"enabled",enabled:!0});return}this.#be(),(this.#l?.interlaced??!0)&&this.#$()}}stop(){this.#u&&(this.#u=!1,this.#Y!==null&&this.#e.cancelVideoFrameCallback(this.#Y),this.#Y=null,this.#kt(),this.#He(),this.#o=0,this.#d=null,this.#k(!1),this.#D(),this.#h?.postMessage({type:"enabled",enabled:!1}))}destroy(){this.stop(),this.#h?.postMessage({type:"destroy"}),this.#h?.terminate(),this.#h=null,this.#D(),this.#Ke("the deinterlacer was destroyed"),this.#n.removeEventListener("webglcontextlost",this.#mt),this.#e.removeEventListener("emptied",this.#ft),this.#e.removeEventListener("resize",this.#ct),this.#e.removeEventListener("pause",this.#C),this.#e.removeEventListener("ended",this.#C),this.#e.removeEventListener("seeking",this.#dt),this.#e.removeEventListener("seeked",this.#C),this.#e.removeEventListener("ratechange",this.#C),this.#_t();for(const e of this.#F)this.#s.deleteTexture(e);this.#F=[],this.#K(),this.#Ye(),this.#s.deleteProgram(this.#x),this.#s.deleteProgram(this.#T),this.#w&&this.#s.deleteProgram(this.#w),this.#L&&this.#s.deleteProgram(this.#L),this.#J&&this.#s.deleteProgram(this.#J),this.#s.getExtension("WEBGL_lose_context")?.loseContext()}capture(){if(this.#r==="active"&&this.#i.style.visibility==="visible"&&this.#h){const s=++this.#vt,r=new Promise((n,o)=>{this.#re.set(s,{resolve:n,reject:o})});return this.#h.postMessage({type:"capture",id:s,width:this.#e.videoWidth,height:this.#e.videoHeight}),r}if(this.#r==="starting"||this.#r==="failed")return createImageBitmap(this.#e);const e=this.#d;if(this.#c&&(!this.#u||this.#M||!e))return Promise.reject(new Error("no rendered picture is available"));if(!this.#u||this.#M||!e)return createImageBitmap(this.#e);e.kind==="texture"?this.#Ge(e.texture,e.flip,!1):e.kind==="yadif"?this.#le(e.flush,e.second,null,!1):this.#ze(null,!1);const t=this.#e.videoWidth,i=this.#e.videoHeight;return t>0&&i>0&&(t!==this.#n.width||i!==this.#n.height)?createImageBitmap(this.#n,{resizeWidth:t,resizeHeight:i,resizeQuality:"high"}):createImageBitmap(this.#n)}addEventListener(e,t,i){super.addEventListener(e,t,i)}removeEventListener(e,t,i){super.removeEventListener(e,t,i)}#be(){this.#c||!this.#u||this.#Y!==null||(this.#Y=this.#e.requestVideoFrameCallback(this.#xt))}#Oe(){const e=[];for(let t=0;t<this.#e.buffered.length;t++)e.push({start:this.#e.buffered.start(t),end:this.#e.buffered.end(t)});return{currentTime:this.#e.currentTime,playbackRate:this.#e.playbackRate,seeking:this.#e.seeking,paused:this.#e.paused,ended:this.#e.ended,readyState:this.#e.readyState,videoWidth:this.#e.videoWidth,videoHeight:this.#e.videoHeight,buffered:e}}#bt(e,t){let i;try{i=new VideoFrame(this.#e,{timestamp:Math.max(0,Math.round(t.mediaTime*1e6))})}catch(r){const n=r instanceof Error?r.message:String(r);this.#A==="auto"&&!this.#pe&&!this.#ie?(this.#Ee(),this.#xe(e,t)):this.#oe(n);return}const s={id:++this.#pt,frame:i,now:e,metadata:t,video:this.#Oe()};if(this.#se){this.#j?.frame.close(),this.#j=s;return}this.#Je(s)}#Je(e){const t=this.#h;if(!t||this.#r!=="active"){e.frame.close();return}this.#se=!0;const i={type:"frame",...e};try{t.postMessage(i,[e.frame])}catch(s){this.#se=!1,e.frame.close();const r=s instanceof Error?s.message:String(s);this.#A==="auto"&&!this.#pe&&!this.#ie?(this.#Ee(),this.#xe(e.now,e.metadata)):this.#oe(r)}}#xt=(e,t)=>{this.#Y=null,!(!this.#u||this.#M)&&(this.#de=e,this.#q=Math.max(this.#q,this.#e.getVideoPlaybackQuality?.().totalVideoFrames??0),this.#Ze(e,t),this.#be())};#Ze(e,t){if(this.#r==="active"){this.#bt(e,t);return}this.#r!=="starting"&&this.#xe(e,t)}ingestExternalFrame(e,t,i){this.#me=i;try{this.#xe(e,t)}finally{this.#me=this.#e}}#xe(e,t){if(this.#yt(t.mediaTime),t.width>0&&t.height>0){let i=!1;if(!this.#te&&this.#e.seeking){const l=this.#e.buffered,d=this.#f>=V?this.#f/1e3:j/1e3;for(let p=0;p<l.length;p++)if(t.mediaTime>=l.start(p)&&t.mediaTime<l.end(p)&&Math.abs(t.mediaTime-this.#e.currentTime)<=d){i=!0;break}}if(i&&(this.#te=!0),(this.#p===0||this.#y===0)&&this.#ot(t.width,t.height),this.#l&&!this.#l.interlaced){this.#Dt();return}const s=t.mediaTime-this.#G,r=i||s<0||s>ce;r&&(this.#o=0,this.#f=0,this.#E.discontinuities++,this.#t.length=0,this.#b());const n=this.#m&&this.#B!==0&&t.presentedFrames-this.#B>1;if(this.#Ct(t.presentedFrames,r),!r&&n&&(this.#o=0,this.#b()),this.#o>0&&t.mediaTime===this.#G)return;!r&&s>0&&this.#Tt(s),this.#G=t.mediaTime;const o=performance.now();o-this.#Ie>J&&(this.#ve=o,this.#N=0,this.#ne=0,this.#he=0,this.#ae=0,this.#Q=0,this.#I=0),this.#Ie=o;const a=performance.now();this.#at();const c=this.#S,h=this.#m&&this.#o===T&&this.#Ft();if(c!==this.#S&&(this.#t.length=0),!(h&&this.#ye()))if(this.#m&&!this.#ke&&this.#S==="film")if(this.#ye()){const l=this.#f*5/4,d=this.#it(1,e,l),p=this.#t.at(-1),E=d?e:p==null?e+l:p.at+p.duration;this.#Rt(E,l)}else this.#ze(null);else if(this.#R&&this.#ye()){const l=this.#f/2,d=this.#it(2,e,l),p=this.#t.at(-1),E=d?e:p==null?e+l*2:p.at+p.duration;this.#tt(!1,E,l),this.#tt(!0,E+l,l)}else this.#E.late+=this.#t.length,this.#t.length=0,this.#le(!1,!1,null);this.#Q=Math.max(this.#Q,this.#t.length),this.#ne+=performance.now()-a,this.#N++,this.#wt(o)}}#yt(e){let t;for(let r=this.#V.length-1;r>=0;r--){const n=this.#V[r];if(n.start<=e+1e-6){t=n;break}}t?.codedSize&&(t.codedSize.width!==this.#p||t.codedSize.height!==this.#y)&&this.#ot(t.codedSize.width,t.codedSize.height);const i=t?.scan;if(!i||this.#l?.interlaced===i.interlaced&&this.#l.topFieldFirst===i.topFieldFirst)return;const s=this.#l?.interlaced;this.#l=i,this.#o=0,this.#t.length=0,this.#b(),s!==i.interlaced&&(this.#f=0),i.interlaced&&(this.#c||this.#r==="main")?this.#$():this.#He()}#ye(){return(this.#R||this.#m)&&this.#f>0&&this.#g.length===L}#Tt(e){const t=e*1e3/(this.#e.playbackRate||1),i=this.#f>0?Math.max(1,Math.round(t/this.#f)):1,s=t/i;s<V||s>j||(this.#f=this.#f>0?this.#f+(s-this.#f)*fe:s)}#et(){if(this.#w&&this.#L&&this.#J)return;const e=this.#s,t=O(e,he),i=O(e,ae),s=O(e,oe);this.#w=t,this.#ce=Object.fromEntries(Object.entries(Y).filter(([r])=>r!=="match"&&r!=="topFieldFirst").map(([r,n])=>[r,e.getUniformLocation(t,n)])),this.#L=i,this.#fe=Object.fromEntries(Object.entries(Y).map(([r,n])=>[r,e.getUniformLocation(i,n)])),this.#J=s,this.#je=Object.fromEntries(Object.entries(Y).map(([r,n])=>[r,e.getUniformLocation(s,n)]))}#Ft(){const e=this.#_,t=this.#w,i=this.#ce,s=this.#J,r=this.#je;if(!e||!t||!i||!s||!r)return!1;const n=this.#s,o=this.#v,a=(this.#v+T-1)%T,c=(this.#v+1)%T,h=this.#ge;n.bindFramebuffer(n.FRAMEBUFFER,e.framebuffer),n.useProgram(t);for(const[g,x]of[c,a,o].entries())n.activeTexture(n.TEXTURE0+g),n.bindTexture(n.TEXTURE_2D,this.#F[x]??null);n.uniform1i(i.prev,0),n.uniform1i(i.cur,1),n.uniform1i(i.next,2),n.uniform2i(i.size,this.#p,this.#y),n.viewport(0,0,M,k),n.drawArrays(n.TRIANGLES,0,3),n.readPixels(0,0,M,k,n.RGBA,n.UNSIGNED_BYTE,e.pixels);const{previousLuma:v,currentLuma:f,nextLuma:l}=e;for(let g=0;g<v.length;g++){const x=g*4;v[g]=e.pixels[x]??0,f[g]=e.pixels[x+1]??0,l[g]=e.pixels[x+2]??0}const d=this.#Se.fieldMatch(v,f,l,h,this.#X);n.useProgram(s),n.uniform1i(r.prev,0),n.uniform1i(r.cur,1),n.uniform1i(r.next,2),n.uniform2i(r.size,this.#p,this.#y),n.uniform1i(r.topFieldFirst,h?1:0),n.uniform1i(r.match,d.match==="p"?0:d.match==="c"?1:2),n.drawArrays(n.TRIANGLES,0,3),n.readPixels(0,0,M,k,n.RGBA,n.UNSIGNED_BYTE,e.pixels);const p=this.#Se.decimate(e.pixels);this.#ee=d.match,this.#Me=d.combScore,this.#ke=d.isCombed,this.#Ae=p.lowestCycleDifference,this.#De=p.runnerUpCycleDifference;const E=p.dropIndex!==null&&!d.isCombed;return(E?"film":"video")!==this.#S&&(this.#S=E?"film":"video"),p.shouldDrop&&!d.isCombed}#Rt(e,t){const i=this.#We();if(i===null)return;const s=this.#g[i];if(s){for(this.#Z=i;this.#t.length>0&&this.#t[0]?.slot===i;)this.#t.shift(),this.#E.late++;this.#ze(s.framebuffer),this.#t.push({slot:i,at:e,duration:t})}}#ze(e,t=!0){const i=this.#L,s=this.#fe;if(!i||!s)return;const r=this.#s,n=this.#v,o=(this.#v+T-1)%T,a=(this.#v+1)%T,c=this.#ge;r.bindFramebuffer(r.FRAMEBUFFER,e),r.useProgram(i);for(const[h,v]of[a,o,n].entries())r.activeTexture(r.TEXTURE0+h),r.bindTexture(r.TEXTURE_2D,this.#F[v]??null);r.uniform1i(s.prev,0),r.uniform1i(s.cur,1),r.uniform1i(s.next,2),r.uniform2i(s.size,this.#p,this.#y),r.uniform1i(s.topFieldFirst,c?1:0),r.uniform1i(s.match,this.#ee==="p"?0:this.#ee==="c"?1:2),r.viewport(0,0,this.#p,this.#y),r.drawArrays(r.TRIANGLES,0,3),e===null&&(this.#d={kind:"film"},this.#k(!0),t&&this.#I++)}#tt(e,t,i){const s=this.#We();if(s===null)return;const r=this.#g[s];if(r){for(this.#Z=s;this.#t.length>0&&this.#t[0]?.slot===s;)this.#t.shift(),this.#E.late++;this.#le(!1,e,r.framebuffer),this.#t.push({slot:s,at:t,duration:i})}}#it(e,t,i){const s=this.#t.at(-1),r=(q+1)*Math.max(this.#W,i);if(s&&s.at-t>r)return this.#t.length=0,this.#E.queueResetted++,!0;const n=Math.max(0,this.#t.length+e-q);let o=0,a=0;for(;a<n;){const c=this.#t.shift();if(!c)break;o+=c.duration,a++}for(const c of this.#t)c.at-=o;return this.#E.late+=a,!1}#We(){const e=this.#d?.kind==="texture"?this.#d.texture:null,t=new Set(this.#t.map(({slot:s})=>s));for(let s=1;s<=L;s++){const r=(this.#Z+s)%L,n=this.#g[r];if(n&&n.texture!==e&&!t.has(r))return r}const i=this.#t[0];if(i){const s=this.#g[i.slot];if(s&&s.texture!==e)return i.slot}return null}#$(){this.#P===null&&(!this.#u||this.#M||(this.#ue=0,this.#P=this.#rt(this.#st)))}#He(){this.#P!==null&&this.#Mt(this.#P),this.#P=null,this.#t.length=0}#st=e=>{if(this.#P=null,!(!this.#u||this.#M)){if(this.#ue>0){const t=e-this.#ue;t>=1&&t<=j&&(this.#W=t<this.#W?t:this.#W+(t-this.#W)*de)}this.#ue=e,this.#r==="main"&&this.#At(e),this.#P=this.#rt(this.#st)}};#rt(e){return this.#c?this.#c.requestAnimationFrame(e):requestAnimationFrame(e)}#Mt(e){this.#c?this.#c.cancelAnimationFrame(e):cancelAnimationFrame(e)}#Xe(){this.#c||this.#U!==null||!this.#u||this.#M||(this.#U=requestAnimationFrame(this.#nt))}#kt(){this.#U!==null&&cancelAnimationFrame(this.#U),this.#U=null}#nt=e=>{this.#U=null,!(!this.#u||this.#M)&&(this.#St(e),this.#U=requestAnimationFrame(this.#nt))};#St(e){if(this.#c||e-this.#de<me||this.#e.paused||this.#e.ended||this.#e.readyState<2)return;const t=this.#e.currentTime,i=this.#e.getVideoPlaybackQuality?.().totalVideoFrames??0,s=this.#f>=V?this.#f:pe,r=i>this.#q,n=t>this.#G&&e-this.#Ce>=s*.75;!r&&!n||(this.#q=Math.max(this.#q,i),this.#Ce=e,this.#Ze(e,{mediaTime:t,presentedFrames:Math.max(this.#B+1,i),width:this.#e.videoWidth,height:this.#e.videoHeight}))}#At(e){const t=e+this.#W*1.5;for(;this.#t[1]&&this.#t[1].at<=t;)this.#E.late++,this.#t.shift();let i=this.#t[0];if(!i||i.at>t)return;this.#t.shift();const s=performance.now();this.#ht(i.slot),this.#ae+=performance.now()-s,this.#he++}#ht(e){const t=this.#g[e];t&&this.#Ge(t.texture)}#Dt(){this.#at();const e=this.#F[this.#v];e&&this.#Ge(e,!0),this.#o=0}#k(e){if(this.#c){this.#c.onVisibility(e);return}this.#i.style.visibility=e?"visible":"hidden"}#Ge(e,t=!1,i=!0){const s=this.#s;s.bindFramebuffer(s.FRAMEBUFFER,null),s.useProgram(this.#T),s.activeTexture(s.TEXTURE0),s.bindTexture(s.TEXTURE_2D,e),s.uniform1i(this.#O,0),s.uniform1i(this.#z,t?1:0),s.viewport(0,0,this.#p,this.#y),s.drawArrays(s.TRIANGLES,0,3),this.#d={kind:"texture",texture:e,flip:t},this.#k(!0),i&&this.#I++}#Ct(e,t){this.#B!==0&&!t&&(this.#E.missed+=Math.max(0,e-this.#B-1)),this.#B=e}#wt(e){const t=e-this.#ve;if(t<J)return;const i=this.#ye()&&(this.#R||this.#S==="film")?this.#he:this.#N,s={...this.#E,dropped:this.#e.getVideoPlaybackQuality?.().droppedVideoFrames??0,fps:i*1e3/t,frameMs:this.#N===0?0:(this.#ne+this.#ae)/this.#N,maxQueuedFields:this.#Q,mode:this.#S,match:this.#ee,combScore:this.#Me,outputFps:this.#I*1e3/t,duplicateScore:this.#Ae,duplicateRunnerUp:this.#De};this.dispatchEvent(new CustomEvent("stats",{detail:s})),this.#Le?.(s),this.#ve=e,this.#N=0,this.#ne=0,this.#he=0,this.#ae=0,this.#Q=0,this.#I=0}#at(){const e=this.#s;this.#v=(this.#v+1)%T,e.bindTexture(e.TEXTURE_2D,this.#F[this.#v]??null),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,this.#me),this.#o=Math.min(this.#o+1,T)}#le(e,t,i,s=!0){if(this.#o===0||this.#M)return;s&&(this.#o===T&&!e?this.#E.filtered++:this.#E.degraded++);const r=this.#s,n=this.#v,o=(this.#v+T-1)%T,a=(this.#v+1)%T;let c,h,v;this.#o===1?c=h=v=n:e?(c=o,h=v=n):this.#o===2?(c=h=o,v=n):(c=a,h=o,v=n),r.bindFramebuffer(r.FRAMEBUFFER,i),r.useProgram(this.#x);for(const[l,d]of[c,h,v].entries())r.activeTexture(r.TEXTURE0+l),r.bindTexture(r.TEXTURE_2D,this.#F[d]??null);r.uniform1i(this.#a.prev,0),r.uniform1i(this.#a.cur,1),r.uniform1i(this.#a.next,2),r.uniform2i(this.#a.size,this.#p,this.#y);const f=this.#ge?0:1;r.uniform1i(this.#a.parity,t?1-f:f),r.uniform1i(this.#a.tff,this.#ge?1:0),r.uniform1i(this.#a.spatialCheck,this.#Re?1:0),r.viewport(0,0,this.#p,this.#y),r.drawArrays(r.TRIANGLES,0,3),i===null&&(this.#d={kind:"yadif",flush:e,second:t},this.#k(!0),s&&this.#I++)}#Te(){if(!this.#H)return;const e=this.#e,t=e.videoWidth,i=e.videoHeight;if(t===0||i===0)return;const s=Math.min(e.offsetWidth/t,e.offsetHeight/i),r=t*s,n=i*s;this.#i.style.left=`${e.offsetLeft+(e.offsetWidth-r)/2}px`,this.#i.style.top=`${e.offsetTop+(e.offsetHeight-n)/2}px`,this.#i.style.width=`${r}px`,this.#i.style.height=`${n}px`}#ot(e,t){const i=this.#s;this.#n.width=e,this.#n.height=t,this.#p=e,this.#y=t,this.#o=0,this.#d=null,this.#b(),this.#Te();for(const s of this.#F)i.deleteTexture(s);this.#F=[];for(let s=0;s<T;s++){const r=i.createTexture();i.bindTexture(i.TEXTURE_2D,r),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MAG_FILTER,i.NEAREST),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),i.texImage2D(i.TEXTURE_2D,0,i.RGBA,e,t,0,i.RGBA,i.UNSIGNED_BYTE,null),this.#F.push(r)}this.#K(),this.#Ye(),this.#m&&this.#lt(),(this.#R||this.#m)&&this.#qe()}#lt(){if(this.#_)return;const e=this.#s,t=e.createTexture();e.bindTexture(e.TEXTURE_2D,t),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,M,k,0,e.RGBA,e.UNSIGNED_BYTE,null);const i=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,i),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,t,0);const s=e.checkFramebufferStatus(e.FRAMEBUFFER)===e.FRAMEBUFFER_COMPLETE;if(e.bindFramebuffer(e.FRAMEBUFFER,null),!s){e.deleteFramebuffer(i),e.deleteTexture(t);return}this.#_={texture:t,framebuffer:i,pixels:new Uint8Array(M*k*4),previousLuma:new Uint8Array(M*k),currentLuma:new Uint8Array(M*k),nextLuma:new Uint8Array(M*k)}}#Ye(){this.#_&&(this.#s.deleteFramebuffer(this.#_.framebuffer),this.#s.deleteTexture(this.#_.texture),this.#_=null)}#qe(){const e=this.#s;if(!(this.#g.length===L||this.#p===0)){this.#K();for(let t=0;t<L;t++){const i=e.createTexture();e.bindTexture(e.TEXTURE_2D,i),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,this.#p,this.#y,0,e.RGBA,e.UNSIGNED_BYTE,null);const s=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,s),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,i,0);const r=e.checkFramebufferStatus(e.FRAMEBUFFER)===e.FRAMEBUFFER_COMPLETE;if(e.bindFramebuffer(e.FRAMEBUFFER,null),!r){e.deleteFramebuffer(s),e.deleteTexture(i),this.#K();return}this.#g.push({texture:i,framebuffer:s})}this.#Z=L-1}}#K(){const e=this.#s,t=this.#d?.kind==="texture"?this.#d.texture:null;this.#g.some(i=>i.texture===t)&&(this.#d=null);for(const{texture:i,framebuffer:s}of this.#g)e.deleteFramebuffer(s),e.deleteTexture(i);this.#g=[],this.#t.length=0}#Lt(){if(this.#H)return;const e=this.#e.parentElement;if(!e)return;const t=document.createElement("div");t.style.cssText="position:relative;display:inline-block;line-height:0;max-width:100%",e.insertBefore(t,this.#e),t.appendChild(this.#e),t.appendChild(this.#i),this.#H=t,this.#Fe?.observe(this.#e),this.#Te()}#_t(){if(this.#c)return;const e=this.#H;this.#H=null,this.#Fe?.disconnect(),this.#i.remove(),e?.parentElement&&(e.parentElement.insertBefore(this.#e,e),e.remove())}#ct=()=>this.#Te();#Ve(e){return!this.#h||this.#r==="main"?!1:(this.#h.postMessage({type:"event",name:e,video:this.#Oe()}),!0)}#ft=()=>{if(this.#Ve("emptied")){this.#D(),this.#k(!1);return}this.#o=0,this.#G=0,this.#t.length=0,this.#f=0,this.#ut(),this.#b(),this.#d=null,this.#k(!1)};#ut(){this.#E={filtered:0,missed:0,degraded:0,discontinuities:0,late:0,queueResetted:0},this.#B=0,this.#ve=0,this.#Ie=0,this.#N=0,this.#ne=0,this.#he=0,this.#ae=0,this.#Q=0,this.#I=0,this.#b()}#b(){this.#t.length=0,this.#S="video",this.#ee="c",this.#Me=0,this.#ke=!0,this.#Se.reset(),this.#Ae=1/0,this.#De=1/0}#dt=()=>{if(this.#Ve("seeking")){this.#D();return}this.#te=!1};#C=e=>{if((e.type==="pause"||e.type==="ended"||e.type==="seeked"||e.type==="ratechange")&&this.#Ve(e.type)){this.#D();return}if(e.type==="seeked"){const i=this.#te;if(this.#te=!1,i)return;this.#o=0,this.#b(),this.#d=null,this.#k(!1);return}const t=e.type==="ratechange";if(t&&(this.#f=0,this.#G=this.#e.currentTime),this.#t.length=0,this.#u&&this.#o>0){const i=this.#We(),s=i===null?void 0:this.#g[i];i!==null&&s?(this.#Z=i,this.#le(!0,!1,s.framebuffer),this.#ht(i)):this.#le(!0,!1,null)}t&&(this.#o=0,this.#b())};#mt=e=>{if(e.preventDefault(),this.#c){this.#c.onFailure("the deinterlacer WebGL context was lost");return}this.#r!=="active"&&(this.#M=!0,this.stop())}}function be(u,e,t,i,s,r,n){return new Ee(u,t,{canvas:e,onFailure:i,onVisibility:s,requestAnimationFrame:r,cancelAnimationFrame:n})}function O(u,e){const t=u.createProgram(),i=ee(u,u.VERTEX_SHADER,ve),s=ee(u,u.FRAGMENT_SHADER,e);if(u.attachShader(t,i),u.attachShader(t,s),u.linkProgram(t),u.deleteShader(i),u.deleteShader(s),!u.getProgramParameter(t,u.LINK_STATUS)){const r=u.getProgramInfoLog(t);throw u.deleteProgram(t),new Error(`the deinterlacer failed to link: ${r??"no reason given"}`)}return t}function ee(u,e,t){const i=u.createShader(e);if(!i)throw new Error("the deinterlacer could not create a shader");if(u.shaderSource(i,t),u.compileShader(i),!u.getShaderParameter(i,u.COMPILE_STATUS)){const s=u.getShaderInfoLog(i);throw u.deleteShader(i),new Error(`the deinterlacer failed to compile: ${s??"no reason given"}`)}return i}const U=self;class xe extends EventTarget{currentTime=0;playbackRate=1;seeking=!1;paused=!0;ended=!1;readyState=0;videoWidth=0;videoHeight=0;parentElement=null;offsetWidth=0;offsetHeight=0;offsetLeft=0;offsetTop=0;#n=[];update(e){this.currentTime=e.currentTime,this.playbackRate=e.playbackRate,this.seeking=e.seeking,this.paused=e.paused,this.ended=e.ended,this.readyState=e.readyState,this.videoWidth=e.videoWidth,this.videoHeight=e.videoHeight,this.#n=e.buffered}get buffered(){return{length:this.#n.length,start:e=>{const t=this.#n[e];if(!t)throw new DOMException("Invalid range index","IndexSizeError");return t.start},end:e=>{const t=this.#n[e];if(!t)throw new DOMException("Invalid range index","IndexSizeError");return t.end}}}getVideoPlaybackQuality(){return{creationTime:performance.now(),droppedVideoFrames:0,totalVideoFrames:0,corruptedVideoFrames:0}}requestVideoFrameCallback(){return 0}cancelVideoFrameCallback(){}}let A=null,F=null,te=!1;function ye(u){return U.requestAnimationFrame(u)}function Te(u){U.cancelAnimationFrame(u)}function C(u,e=[]){U.postMessage(u,e)}function Fe(u,e){u.doubleRate=e.doubleRate,u.autoFilm=e.autoFilm,u.filmCombThreshold=e.filmCombThreshold}U.onmessage=u=>{const e=u.data;try{if(e.type==="initialize"){if(typeof U.requestAnimationFrame!="function")throw new Error("requestAnimationFrame is unavailable in this Worker");A=new xe,A.update(e.video),F=be(A,e.canvas,e.options,t=>{te||C({type:"failed",message:t})},t=>C({type:"visibility",visible:t}),ye,Te),F.addEventListener("stats",t=>{const{dropped:i,...s}=t.detail;C({type:"stats",stats:s})}),F.scan=e.scan,F.videoTimeline=e.videoTimeline,F.enabled=e.enabled,C({type:"ready"});return}if(!A||!F)return;switch(e.type){case"frame":A.update(e.video);try{F.ingestExternalFrame(performance.now(),e.metadata,e.frame)}finally{e.frame.close(),C({type:"consumed",id:e.id})}break;case"settings":Fe(F,e.options);break;case"scan":F.scan=e.scan;break;case"timeline":F.videoTimeline=e.videoTimeline;break;case"enabled":F.enabled=e.enabled;break;case"event":A.update(e.video),A.dispatchEvent(new Event(e.name));break;case"capture":A.videoWidth=e.width,A.videoHeight=e.height,F.capture().then(t=>C({type:"capture",id:e.id,image:t},[t])).catch(()=>C({type:"capture",id:e.id,image:null}));break;case"destroy":te=!0,F.destroy(),F=null,A=null,U.close();break}}catch(t){const i=t instanceof Error?t.message:String(t);C({type:"failed",message:i})}}})();
//# sourceMappingURL=worker-U0VPqa8n.js.map
