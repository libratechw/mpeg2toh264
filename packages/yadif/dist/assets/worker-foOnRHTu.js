...
`;function Re(u){return Math.max(0,Math.round(u*1e6))}class ke{#r;#t=!1;#e=0;#i=0;constructor(e,i=!1){this.#r=e,this.#t=i}get enabled(){return this.#r!==void 0||this.#t}get generation(){return this.#e}get frameId(){return this.#i}invalidate(){return this.#e+=1,this.#e}destroy(){this.#r=void 0,this.#t=!1}deliver(e){this.#r?.(e)}emit(e,i,t,r,n){const s=this.#r;if(!s&&!this.#t)return null;this.#i+=1;const a={source:e,mediaTimestampUs:i,generation:this.#e,frameId:this.#i,second:t,width:r,height:n};return s?.(a),a}}class Ae extends EventTarget{#r;#t;#e;#i;#y;#o;#T;#U;#L;#I=null;#Fe=null;#N=null;#Me=null;#re=null;#ft=null;#B=null;#F=[];#x=[];#ne=U-1;#m=null;#n=[];#O=null;#Re=0;#W=null;#ae=be;#z=null;#Oe;#M;#v;#q;#We;#D="video";#he="c";#Ge=0;#He=!0;#Xe=new T(k,A);#ze=1/0;#qe=1/0;#G=0;#a=0;#f=0;#p=0;#g=x-1;#u=0;#oe=0;#ke=Number.NaN;#le=!1;#Q=null;#Ae=0;#Y=0;#Qe=0;#d=!1;#Se=!1;#we=!1;#l=null;#V=[];#R=!1;#Ye;#De;#j;#A;#$;#ce=0;#ue;#Ce;#Ve=!1;#C;#K;#J;#fe=null;#Z;#c;#_e;#S;#je;#h=null;#s;#de=!1;#$e=0;#Ke=!1;#It=0;#me=!1;#Pe=!1;#ee=null;#Nt=0;#pe=new Map;#w={filtered:0,missed:0,degraded:0,discontinuities:0,late:0,queueResetted:0};#H=0;#Je=0;#Ue=0;#X=0;#ve=0;#ge=0;#Ee=0;#te=0;constructor(e,i={},t=null){if(super(),this.#e=e,this.#M=i.doubleRate??!1,this.#v=i.autoFilm??!1,this.#q=ne(i.filmCombThreshold??T.COMBED_PIXEL_LIMIT),this.#We=i.spatialCheck??!0,this.#Ye=i.onStats,this.#De=i.diagnostic?.onFilteredPicture,this.#j=i.diagnostic?.onPresentedFrame,i.presenter!==void 0){if(i.diagnostic?.onQueuedFrame!==void 0||i.diagnostic?.onQueuedMeta!==void 0||i.queuedFrameSink!==void 0)throw new TypeError("presenter cannot be combined with diagnostic frame transport");if(typeof VideoFrame>"u")throw new TypeError("presenter requires VideoFrame")}if(this.#$=i.presenter??null,this.#A=i.presenter?(s,a)=>i.presenter(s,{mediaTimestampUs:a.mediaTimestampUs,durationUs:a.durationUs}):i.diagnostic?.onQueuedFrame,this.#ue=i.diagnostic?.onQueuedMeta,this.#Ce=i.queuedFrameSink??null,this.#C=i.diagnostic?.onPresentationQueue,this.#K=(this.#A!==void 0||this.#ue!==void 0)&&(i.presenter!==void 0||i.diagnostic?.bypassDisplayQueue===!0),this.#J=i.presenter!==void 0||i.diagnostic?.captureQueuedFrameFullSize===!0,this.#J&&this.#A===void 0&&this.#ue===void 0)throw new TypeError("captureQueuedFrameFullSize requires onQueuedFrame or onQueuedMeta");if(this.#J&&!this.#K)throw new TypeError("captureQueuedFrameFullSize requires bypassDisplayQueue");this.#Z=this.#De||this.#j||this.#A||this.#C?new ke(this.#De,this.#j!==void 0||this.#A!==void 0||this.#C!==void 0):null,this.#c=t,this.#S=t?"main":i.rendering??"auto",this.#je=i.workerUrl??ve,this.#s=this.#S==="main"?"main":"idle",this.#t=t?t.canvas:document.createElement("canvas"),this.#r=t?.canvas??(this.#S==="main"?this.#t:document.createElement("canvas")),this.#_e=e,t||(this.#t.style.cssText="position:absolute;pointer-events:none;visibility:hidden");const r=this.#r.getContext("webgl2",{alpha:!1,antialias:!1,depth:!1,stencil:!1,preserveDrawingBuffer:!1,powerPreference:"high-performance"});if(!r)throw new Error("this browser has no WebGL2");this.#i=r,this.#y=H(r,fe);const n=this.#y;this.#o=Object.fromEntries(Object.entries(ue).map(([s,a])=>[s,r.getUniformLocation(n,a)])),this.#T=H(r,Me),this.#U=r.getUniformLocation(this.#T,"uField"),this.#L=r.getUniformLocation(this.#T,"uFlip"),this.#Bt(),this.#v&&this.#Tt(),this.#r.addEventListener("webglcontextlost",this.#Lt),this.#Oe=t?null:new ResizeObserver(()=>this.#Be()),e.addEventListener("emptied",this.#_t),e.addEventListener("resize",this.#Ct),e.addEventListener("pause",this.#P),e.addEventListener("ended",this.#P),e.addEventListener("seeking",this.#Ut),e.addEventListener("seeked",this.#P),e.addEventListener("ratechange",this.#P)}get running(){return this.#d&&(this.#l?.interlaced??!0)}get renderPath(){return{rendering:this.#S,workerState:this.#s,externalHost:this.#c!==null,presenterFailures:this.#ce}}get canvas(){return this.#t}get#Le(){return this.#l?.topFieldFirst!==!1}#dt(){return{doubleRate:this.#M,autoFilm:this.#v,filmCombThreshold:this.#q,spatialCheck:this.#We,diagnostic:this.#De!==void 0,capturePresentedFrames:this.#j!==void 0,captureQueuedFrames:this.#A!==void 0,captureQueuedFrameFullSize:this.#J,capturePresentationQueue:this.#C!==void 0,bypassDisplayQueue:this.#K,captureQueuedMeta:this.#ue!==void 0}}get enabled(){return this.#Se}set enabled(e){this.#Se=e,this.#it(),this.#h?.postMessage({type:"enabled",enabled:e})}set scan(e){const i=this.#l?.interlaced!==e?.interlaced,t=i||this.#l?.topFieldFirst!==e?.topFieldFirst;this.#l=e,this.#h?.postMessage({type:"scan",scan:e}),t&&(this.#u=0,this.#b(),this.#E(),i&&(this.#a=0),this.#m=null,this.#k(!1)),this.#it(),t&&((e?.interlaced??!0)&&(this.#c||this.#s==="main")?this.#ie():this.#at())}get scan(){return this.#l}set videoTimeline(e){this.#V=e,this.#h?.postMessage({type:"timeline",videoTimeline:e}),e.length===0&&(this.#l=null),this.#it()}get videoTimeline(){return this.#V}get container(){return this.#z??this.#e}get doubleRate(){return this.#M}set doubleRate(e){e!==this.#M&&(this.#M=e,this.#tt(),this.#n.length=0,this.#E(),e?(this.#f>0&&this.#ct(),(this.#l?.interlaced??!0)&&(this.#c||this.#s==="main")&&this.#ie()):this.#v||(this.#m=null,this.#k(!1),this.#se()))}get autoFilm(){return this.#v}set autoFilm(e){e!==this.#v&&(this.#v=e,this.#tt(),this.#b(),this.#E(),e?(this.#Tt(),this.#f>0&&(this.#Dt(),this.#ct()),(this.#l?.interlaced??!0)&&(this.#c||this.#s==="main")&&this.#ie()):(this.#lt(),this.#M||(this.#m=null,this.#k(!1),this.#se())))}get filmCombThreshold(){return this.#q}set filmCombThreshold(e){const i=ne(e);i!==this.#q&&(this.#q=i,this.#tt(),this.#v&&this.#b())}get diagnosticGeneration(){return this.#Z?.generation??0}#mt(e,i,t){const r=this.#Z;return!r||this.#s!=="main"||!Number.isFinite(i)?null:r.emit(e,Re(i),t,this.#f,this.#p)}#Ze(e,i){const t={timestamp:e};Number.isFinite(i)&&i>0&&(t.duration=Math.max(1,Math.round(i*1e3)));const r=this.#e.videoWidth,n=this.#e.videoHeight;return r>0&&n>0&&(t.displayWidth=r,t.displayHeight=n),t}#et(e,i){const t=this.#j;if(!t||!e||typeof VideoFrame>"u")return;const r=this.#Ze(e.mediaTimestampUs,i),n=r.duration??null;let s;try{s=new VideoFrame(this.#r,r)}catch{return}try{t(s,{...e,presentationTimeMs:performance.now(),durationUs:n})}catch{s.close()}}#pt(e,i=!1){const t=this.#i;t.bindFramebuffer(t.FRAMEBUFFER,null),t.useProgram(this.#T),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,e),t.uniform1i(this.#U,0),t.uniform1i(this.#L,i?1:0),t.viewport(0,0,this.#f,this.#p),t.drawArrays(t.TRIANGLES,0,3)}#vt(e,i,t){const r=this.#A;if(!r||!i||typeof VideoFrame>"u"){this.#$&&(this.#ce+=1);return}const n=performance.now();if(this.#J){try{this.#pt(e)}catch{this.#$&&(this.#ce+=1);return}const d=this.#Ze(i.mediaTimestampUs,t),c=d.duration??null;let h;try{h=new VideoFrame(this.#r,d)}catch{this.#$&&(this.#ce+=1);return}try{r(h,{...i,queuedAtMs:n,durationUs:c,captureWidth:this.#f,captureHeight:this.#p})}catch{this.#$&&(this.#ce+=1),h.close()}return}const s=this.#fe;if(!s)return;const a=this.#i;try{a.bindFramebuffer(a.FRAMEBUFFER,s.framebuffer),a.useProgram(this.#T),a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,e),a.uniform1i(this.#U,0),a.uniform1i(this.#L,0),a.viewport(0,0,D,S),a.drawArrays(a.TRIANGLES,0,3),a.readPixels(0,0,D,S,a.RGBA,a.UNSIGNED_BYTE,s.pixels);const d=D*4;for(let h=0;h<S;h++){const f=(S-1-h)*d;s.flipped.set(s.pixels.subarray(f,f+d),h*d)}const c=s.context.createImageData(D,S);c.data.set(s.flipped),s.context.putImageData(c,0,0)}catch{a.bindFramebuffer(a.FRAMEBUFFER,null),a.viewport(0,0,this.#f,this.#p);return}a.bindFramebuffer(a.FRAMEBUFFER,null),a.viewport(0,0,this.#f,this.#p);const o=this.#Ze(i.mediaTimestampUs,t),m=o.duration??null;let l;try{l=new VideoFrame(s.canvas,o)}catch{return}try{r(l,{...i,queuedAtMs:n,durationUs:m,captureWidth:D,captureHeight:S})}catch{l.close()}}#Bt(){if(!this.#A||this.#J||this.#fe)return;let e=null;if(typeof OffscreenCanvas<"u")e=new OffscreenCanvas(D,S);else if(typeof document<"u"){const a=document.createElement("canvas");a.width=D,a.height=S,e=a}if(!e)return;const i=e.getContext("2d",{willReadFrequently:!0});if(!i)return;const t=this.#i,r=t.createTexture();if(!r)return;t.bindTexture(t.TEXTURE_2D,r),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texImage2D(t.TEXTURE_2D,0,t.RGBA,D,S,0,t.RGBA,t.UNSIGNED_BYTE,null);const n=t.createFramebuffer();if(!n){t.deleteTexture(r);return}t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,r,0);const s=t.checkFramebufferStatus(t.FRAMEBUFFER)===t.FRAMEBUFFER_COMPLETE;if(t.bindFramebuffer(t.FRAMEBUFFER,null),!s){t.deleteFramebuffer(n),t.deleteTexture(r);return}this.#fe={texture:r,framebuffer:n,canvas:e,context:i,pixels:new Uint8Array(D*S*4),flipped:new Uint8ClampedArray(D*S*4)}}#Ot(){const e=this.#fe;e&&(this.#i.deleteFramebuffer(e.framebuffer),this.#i.deleteTexture(e.texture),this.#fe=null)}#E(){this.#Z?.invalidate()}#tt(){this.#h?.postMessage({type:"settings",options:this.#dt()})}#it(){this.#Se&&(this.#V.length>0||(this.#l?.interlaced??!0))?this.start():this.stop()}#Wt(){return this.#c||this.#S==="main"?!1:this.#s==="starting"||this.#s==="active"?!0:typeof Worker<"u"&&typeof VideoFrame<"u"&&typeof OffscreenCanvas<"u"&&this.#je!==null&&"transferControlToOffscreen"in HTMLCanvasElement.prototype?(this.#gt(),!0):this.#S==="auto"?(this.#Ie(),!1):(this.#s="failed",this.#d=!1,!0)}#gt(){this.#_(),this.#h?.terminate(),this.#h=null,this.#me=!1,this.#Pe=!1;let e=this.#t;if(this.#Ke){e=document.createElement("canvas"),e.className=this.#t.className;const s=this.#t.getAttribute("style");s===null?e.removeAttribute("style"):e.setAttribute("style",s),e.style.visibility="hidden",this.#t.parentElement&&this.#t.replaceWith(e),this.#t=e}const i=++this.#$e;this.#E(),this.#s="starting";let t,r;try{r=e.transferControlToOffscreen(),this.#Ke=!0,t=new Worker(this.#je,{type:"module"})}catch(s){this.#be(s instanceof Error?s.message:String(s));return}this.#h=t,t.onmessage=s=>{i===this.#$e&&!this.#we?this.#Gt(s.data):(s.data.type==="presented"||s.data.type==="queued")&&s.data.frame.close()},t.onerror=s=>{i===this.#$e&&(s.preventDefault(),this.#be(s.message||"the deinterlacer worker failed"))};const n=[r];this.#Ce&&!this.#Ve&&(n.push(this.#Ce),this.#Ve=!0),t.postMessage({type:"initialize",canvas:r,options:this.#dt(),queuedFrameSink:this.#Ve?this.#Ce:null,scan:this.#l,videoTimeline:this.#V,enabled:this.#d,video:this.#st()},n)}#Gt(e){switch(e.type){case"ready":this.#s="active",this.#d&&(this.#ye(),this.#ht());break;case"failed":this.#be(e.message);break;case"consumed":{this.#me=!1,this.#Pe=!0;const i=this.#ee;this.#ee=null,i&&this.#bt(i);break}case"visibility":this.#t.style.visibility=e.visible?"visible":"hidden";break;case"diagnostic":{if(this.#s!=="active")break;this.#Z?.deliver(e.meta);break}case"queuedMeta":{if(this.#s!=="active")break;try{this.#ue?.(e.meta)}catch{}break}case"presented":{if(this.#s!=="active"){e.frame.close();break}const i=this.#j;if(!i){e.frame.close();break}try{i(e.frame,e.meta)}catch{e.frame.close()}break}case"queued":{if(this.#s!=="active"){e.frame.close();break}const i=this.#A;if(!i){e.frame.close();break}try{i(e.frame,e.meta)}catch{e.frame.close()}break}case"presentationQueue":this.#s==="active"&&this.#C?.(e.meta);break;case"stats":{const i={...e.stats,dropped:this.#e.getVideoPlaybackQuality?.().droppedVideoFrames??0};this.dispatchEvent(new CustomEvent("stats",{detail:i})),this.#Ye?.(i);break}case"capture":{const i=this.#pe.get(e.id);if(this.#pe.delete(e.id),!i){e.image?.close();break}e.image?i.resolve(e.image):createImageBitmap(this.#e).then(i.resolve,i.reject);break}}}#be(e){if(this.#s==="starting"&&this.#S==="auto"&&!this.#de){this.#Ie();return}if(this.#Et(e),!this.#de){this.#de=!0,this.#gt();return}console.error(`Deinterlacer Worker stopped: ${e}`),this.#s="failed",this.#h?.terminate(),this.#h=null,this.#_(),this.stop()}#Ie(){const e=this.#r;e.className=this.#t.className;const i=this.#t.getAttribute("style");i===null?e.removeAttribute("style"):e.setAttribute("style",i),e.style.visibility="hidden",this.#t.parentElement&&this.#t.replaceWith(e),this.#t=e,this.#Ke=!1,this.#h?.terminate(),this.#h=null,this.#s="main",this.#E(),this.#_(),this.#d&&(this.#ye(),this.#ht(),(this.#l?.interlaced??!0)&&this.#ie())}#_(){this.#ee?.frame.close(),this.#ee=null}#Et(e){for(const i of this.#pe.values())i.reject(new Error(e));this.#pe.clear()}start(){if(!(this.#d||this.#we||this.#R)){if(this.#d=!0,this.#Pt(),this.#b(),this.#Ae=performance.now(),this.#Qe=this.#Ae,this.#ke=Number.NaN,this.#Y=this.#e.getVideoPlaybackQuality?.().totalVideoFrames??0,this.#ii(),this.#ht(),this.#Wt()){this.#h?.postMessage({type:"enabled",enabled:!0}),this.#s==="active"&&this.#ye();return}this.#ye(),(this.#l?.interlaced??!0)&&this.#ie()}}stop(){this.#d&&(this.#d=!1,this.#Q!==null&&this.#e.cancelVideoFrameCallback(this.#Q),this.#Q=null,this.#jt(),this.#at(),this.#u=0,this.#m=null,this.#k(!1),this.#E(),this.#_(),this.#h?.postMessage({type:"enabled",enabled:!1}))}destroy(){if(!this.#we){this.#we=!0,this.#Se=!1,this.stop(),this.#h?.postMessage({type:"destroy"}),this.#h?.terminate(),this.#h=null,this.#E(),this.#Z?.destroy(),this.#_(),this.#Et("the deinterlacer was destroyed"),this.#r.removeEventListener("webglcontextlost",this.#Lt),this.#e.removeEventListener("emptied",this.#_t),this.#e.removeEventListener("resize",this.#Ct),this.#e.removeEventListener("pause",this.#P),this.#e.removeEventListener("ended",this.#P),this.#e.removeEventListener("seeking",this.#Ut),this.#e.removeEventListener("seeked",this.#P),this.#e.removeEventListener("ratechange",this.#P),this.#si();for(const e of this.#F)this.#i.deleteTexture(e);this.#F=[],this.#Ot(),this.#se(),this.#lt(),this.#i.deleteProgram(this.#y),this.#i.deleteProgram(this.#T),this.#I&&this.#i.deleteProgram(this.#I),this.#N&&this.#i.deleteProgram(this.#N),this.#re&&this.#i.deleteProgram(this.#re),this.#i.getExtension("WEBGL_lose_context")?.loseContext()}}capture(){if(this.#s==="active"&&this.#t.style.visibility==="visible"&&this.#h){const r=++this.#Nt,n=new Promise((s,a)=>{this.#pe.set(r,{resolve:s,reject:a})});return this.#h.postMessage({type:"capture",id:r,width:this.#e.videoWidth,height:this.#e.videoHeight}),n}if(this.#s==="starting"||this.#s==="failed")return createImageBitmap(this.#e);const e=this.#m;if(this.#c&&(!this.#d||this.#R||!e))return Promise.reject(new Error("no rendered picture is available"));if(!this.#d||this.#R||!e)return createImageBitmap(this.#e);e.kind==="texture"?this.#ot(e.texture,e.flip,!1):e.kind==="yadif"?this.#xe(e.flush,e.second,null,!1):this.#rt(null,!1);const i=this.#e.videoWidth,t=this.#e.videoHeight;return i>0&&t>0&&(i!==this.#r.width||t!==this.#r.height)?createImageBitmap(this.#r,{resizeWidth:i,resizeHeight:t,resizeQuality:"high"}):createImageBitmap(this.#r)}addEventListener(e,i,t){super.addEventListener(e,i,t)}removeEventListener(e,i,t){super.removeEventListener(e,i,t)}#ye(){this.#c||!this.#d||this.#Q!==null||(this.#Q=this.#e.requestVideoFrameCallback(this.#Xt))}#st(){const e=[];for(let i=0;i<this.#e.buffered.length;i++)e.push({start:this.#e.buffered.start(i),end:this.#e.buffered.end(i)});return{currentTime:this.#e.currentTime,playbackRate:this.#e.playbackRate,seeking:this.#e.seeking,paused:this.#e.paused,ended:this.#e.ended,readyState:this.#e.readyState,videoWidth:this.#e.videoWidth,videoHeight:this.#e.videoHeight,buffered:e}}#Ht(e,i){let t;try{t=new VideoFrame(this.#e,{timestamp:Math.max(0,Math.round(i.mediaTime*1e6))})}catch(n){const s=n instanceof Error?n.message:String(n);this.#S==="auto"&&!this.#Pe&&!this.#de?(this.#Ie(),this.#Ne(e,i)):this.#be(s);return}const r={id:++this.#It,frame:t,now:e,metadata:i,video:this.#st()};if(this.#me){this.#ee?.frame.close(),this.#ee=r;return}this.#bt(r)}#bt(e){const i=this.#h;if(!i||this.#s!=="active"){e.frame.close();return}this.#me=!0;const t={type:"frame",...e};try{i.postMessage(t,[e.frame])}catch(r){this.#me=!1,e.frame.close();const n=r instanceof Error?r.message:String(r);this.#S==="auto"&&!this.#Pe&&!this.#de?(this.#Ie(),this.#Ne(e.now,e.metadata)):this.#be(n)}}#Xt=(e,i)=>{this.#Q=null,!(!this.#d||this.#R)&&(this.#Ae=e,this.#Y=Math.max(this.#Y,this.#e.getVideoPlaybackQuality?.().totalVideoFrames??0),this.#yt(e,i),this.#ye())};#yt(e,i){if(this.#ke=i.mediaTime,this.#s==="active"){this.#Ht(e,i);return}this.#s!=="starting"&&this.#Ne(e,i)}ingestExternalFrame(e,i,t){this.#_e=t;try{this.#Ne(e,i)}finally{this.#_e=this.#e}}#Ne(e,i){if(this.#zt(i.mediaTime),i.width>0&&i.height>0){let t=!1;if(!this.#le&&this.#e.seeking){const h=this.#e.buffered,f=this.#a>=J?this.#a/1e3:Z/1e3;for(let p=0;p<h.length;p++)if(i.mediaTime>=h.start(p)&&i.mediaTime<h.end(p)&&Math.abs(i.mediaTime-this.#e.currentTime)<=f){t=!0;break}}if(t&&(this.#le=!0),(this.#f===0||this.#p===0)&&this.#wt(i.width,i.height),this.#l&&!this.#l.interlaced){this.#Jt();return}const r=i.mediaTime-this.#oe,n=t||r<0||r>ge;n&&(this.#u=0,this.#a=0,this.#w.discontinuities++,this.#E(),this.#n.length=0,this.#b());const s=this.#v&&this.#H!==0&&i.presentedFrames-this.#H>1;if(this.#ei(i.presentedFrames,n),!n&&s&&(this.#u=0,this.#b()),this.#u>0&&i.mediaTime===this.#oe)return;!n&&r>0&&this.#qt(r),this.#oe=i.mediaTime;const a=performance.now();a-this.#Je>re&&(this.#Ue=a,this.#X=0,this.#ve=0,this.#ge=0,this.#Ee=0,this.#te=0,this.#G=0),this.#Je=a;const o=performance.now();this.#St();const m=this.#D,l=this.#v&&this.#u===x&&this.#Qt();if(m!==this.#D&&(this.#n.length=0),!(l&&this.#Te()))if(this.#v&&!this.#He&&this.#D==="film")if(this.#Te()){const h=this.#a*5/4;this.#Ft(1);const f=this.#n.at(-1),p=f==null?e+h:f.at+f.duration;this.#Yt(p,h,i.mediaTime)}else this.#rt(null,!0,i.mediaTime);else if(this.#M&&this.#Te()){const h=this.#a/2;this.#Ft(2);const f=this.#n.at(-1),p=f==null?e+h*2:f.at+f.duration;this.#xt(!1,p,h,i.mediaTime),this.#xt(!0,p+h,h,i.mediaTime+h/1e3)}else this.#w.late+=this.#n.length,this.#n.length=0,this.#xe(!1,!1,null,!0,i.mediaTime);this.#te=Math.max(this.#te,this.#n.length),this.#ve+=performance.now()-o,this.#X++,this.#ti(a)}}#zt(e){let i;for(let n=this.#V.length-1;n>=0;n--){const s=this.#V[n];if(s.start<=e+1e-6){i=s;break}}i?.codedSize&&(i.codedSize.width!==this.#f||i.codedSize.height!==this.#p)&&this.#wt(i.codedSize.width,i.codedSize.height);const t=i?.scan;if(!t||this.#l?.interlaced===t.interlaced&&this.#l.topFieldFirst===t.topFieldFirst)return;const r=this.#l?.interlaced;this.#l=t,this.#u=0,this.#n.length=0,this.#b(),this.#E(),r!==t.interlaced&&(this.#a=0),t.interlaced&&(this.#c||this.#s==="main")?this.#ie():this.#at()}#Te(){return(this.#M||this.#v)&&this.#a>0&&this.#x.length===U}#qt(e){const i=e*1e3/(this.#e.playbackRate||1),t=this.#a>0?Math.max(1,Math.round(i/this.#a)):1,r=i/t;r<J||r>Z||(this.#a=this.#a>0?this.#a+(r-this.#a)*Ee:r)}#Tt(){if(this.#I&&this.#N&&this.#re)return;const e=this.#i,i=H(e,de),t=H(e,me),r=H(e,pe);this.#I=i,this.#Fe=Object.fromEntries(Object.entries(K).filter(([n])=>n!=="match"&&n!=="topFieldFirst").map(([n,s])=>[n,e.getUniformLocation(i,s)])),this.#N=t,this.#Me=Object.fromEntries(Object.entries(K).map(([n,s])=>[n,e.getUniformLocation(t,s)])),this.#re=r,this.#ft=Object.fromEntries(Object.entries(K).map(([n,s])=>[n,e.getUniformLocation(r,s)]))}#Qt(){const e=this.#B,i=this.#I,t=this.#Fe,r=this.#re,n=this.#ft;if(!e||!i||!t||!r||!n)return!1;const s=this.#i,a=this.#g,o=(this.#g+x-1)%x,m=(this.#g+1)%x,l=this.#Le;s.bindFramebuffer(s.FRAMEBUFFER,e.framebuffer),s.useProgram(i);for(const[g,y]of[m,o,a].entries())s.activeTexture(s.TEXTURE0+g),s.bindTexture(s.TEXTURE_2D,this.#F[y]??null);s.uniform1i(t.prev,0),s.uniform1i(t.cur,1),s.uniform1i(t.next,2),s.uniform2i(t.size,this.#f,this.#p),s.viewport(0,0,k,A),s.drawArrays(s.TRIANGLES,0,3),s.readPixels(0,0,k,A,s.RGBA,s.UNSIGNED_BYTE,e.pixels);const{previousLuma:d,currentLuma:c,nextLuma:h}=e;for(let g=0;g<d.length;g++){const y=g*4;d[g]=e.pixels[y]??0,c[g]=e.pixels[y+1]??0,h[g]=e.pixels[y+2]??0}const f=this.#Xe.fieldMatch(d,c,h,l,this.#q);s.useProgram(r),s.uniform1i(n.prev,0),s.uniform1i(n.cur,1),s.uniform1i(n.next,2),s.uniform2i(n.size,this.#f,this.#p),s.uniform1i(n.topFieldFirst,l?1:0),s.uniform1i(n.match,f.match==="p"?0:f.match==="c"?1:2),s.drawArrays(s.TRIANGLES,0,3),s.readPixels(0,0,k,A,s.RGBA,s.UNSIGNED_BYTE,e.pixels);const p=this.#Xe.decimate(e.pixels);this.#he=f.match,this.#Ge=f.combScore,this.#He=f.isCombed,this.#ze=p.lowestCycleDifference,this.#qe=p.runnerUpCycleDifference;const E=p.dropIndex!==null&&!f.isCombed;return(E?"film":"video")!==this.#D&&(this.#D=E?"film":"video"),p.shouldDrop&&!f.isCombed}#Yt(e,i,t){const r=this.#nt();if(r===null)return;const n=this.#x[r];if(!n)return;this.#ne=r;const s=this.#rt(n.framebuffer,!0,t);this.#vt(n.texture,s,i),this.#K||this.#n.push({slot:r,at:e,enqueuedAtMs:this.#C?performance.now():null,duration:i,diagnosticMeta:s})}#rt(e,i=!0,t=Number.NaN){const r=this.#N,n=this.#Me;if(!r||!n)return null;const s=this.#i,a=this.#g,o=(this.#g+x-1)%x,m=(this.#g+1)%x,l=this.#Le;s.bindFramebuffer(s.FRAMEBUFFER,e),s.useProgram(r);for(const[c,h]of[m,o,a].entries())s.activeTexture(s.TEXTURE0+c),s.bindTexture(s.TEXTURE_2D,this.#F[h]??null);s.uniform1i(n.prev,0),s.uniform1i(n.cur,1),s.uniform1i(n.next,2),s.uniform2i(n.size,this.#f,this.#p),s.uniform1i(n.topFieldFirst,l?1:0),s.uniform1i(n.match,this.#he==="p"?0:this.#he==="c"?1:2),s.viewport(0,0,this.#f,this.#p),s.drawArrays(s.TRIANGLES,0,3);const d=i?this.#mt("film",t,!1):null;return e===null&&(this.#m={kind:"film"},this.#k(!0),i&&(this.#G++,this.#et(d,this.#a))),d}#xt(e,i,t,r){const n=this.#nt();if(n===null)return;const s=this.#x[n];if(!s)return;this.#ne=n;const a=this.#xe(!1,e,s.framebuffer,!0,r);this.#vt(s.texture,a,t),this.#K||this.#n.push({slot:n,at:i,enqueuedAtMs:this.#C?performance.now():null,duration:t,diagnosticMeta:a})}#Ft(e){const i=Math.max(0,this.#n.length+e-se);let t=0,r=0;for(;r<i;){const n=this.#n.shift();if(!n)break;t+=n.duration,r++}for(const n of this.#n)n.at-=t;this.#w.late+=r}#nt(){const e=this.#m?.kind==="texture"?this.#m.texture:null,i=new Set(this.#n.map(({slot:t})=>t));for(let t=1;t<=U;t++){const r=(this.#ne+t)%U,n=this.#x[r];if(n&&n.texture!==e&&!i.has(r))return r}return null}#ie(){this.#O===null&&(!this.#d||this.#R||(this.#Re=0,this.#O=this.#Rt(this.#Mt)))}#at(){this.#O!==null&&this.#Vt(this.#O),this.#O=null,this.#n.length=0}#Mt=e=>{if(this.#O=null,!(!this.#d||this.#R)){if(this.#Re>0){const i=e-this.#Re;i>=1&&i<=Z&&(this.#ae=i<this.#ae?i:this.#ae+(i-this.#ae)*ye)}this.#Re=e,this.#s==="main"&&this.#Kt(e),this.#O=this.#Rt(this.#Mt)}};#Rt(e){return this.#c?this.#c.requestAnimationFrame(e):requestAnimationFrame(e)}#Vt(e){this.#c?this.#c.cancelAnimationFrame(e):cancelAnimationFrame(e)}#ht(){this.#c||this.#W!==null||!this.#d||this.#R||(this.#W=requestAnimationFrame(this.#kt))}#jt(){this.#W!==null&&cancelAnimationFrame(this.#W),this.#W=null}#kt=e=>{this.#W=null,!(!this.#d||this.#R)&&(this.#$t(e),this.#W=requestAnimationFrame(this.#kt))};#$t(e){if(this.#c||e-this.#Ae<Te||this.#e.paused||this.#e.ended||this.#e.readyState<2)return;const i=this.#e.currentTime,t=this.#e.getVideoPlaybackQuality?.().totalVideoFrames??0,r=this.#a>=J?this.#a:xe,n=t>this.#Y,s=i!==this.#ke&&e-this.#Qe>=r*.75;!n&&!s||(this.#Y=Math.max(this.#Y,t),this.#Qe=e,this.#yt(e,{mediaTime:i,presentedFrames:Math.max(this.#H+1,t),width:this.#e.videoWidth,height:this.#e.videoHeight}))}#Kt(e){const i=e+this.#ae*1.5,t=this.#n.length;let r=0;const n=[];for(;this.#n[1]&&this.#n[1].at<=i;){this.#w.late++;const o=this.#n.shift();o&&n.push({frameId:o.diagnosticMeta?.frameId??null,generation:o.diagnosticMeta?.generation??null,mediaTimestampUs:o.diagnosticMeta?.mediaTimestampUs??null,plannedAtMs:o.at,enqueuedAtMs:o.enqueuedAtMs,reason:"deadline"}),r++}let s=this.#n[0];if(this.#C?.({atMs:e,deadlineMs:i,queueLengthBefore:t,retired:r,queueLengthAfter:this.#n.length,selectedFrameId:s?.diagnosticMeta?.frameId??null,selectedAtMs:s?.at??null,selectedEnqueuedAtMs:s?.enqueuedAtMs??null,retiredFields:n}),!s||s.at>i)return;this.#n.shift();const a=performance.now();this.#At(s.slot,s.diagnosticMeta,s.duration),this.#Ee+=performance.now()-a,this.#ge++}#At(e,i=null,t=0){const r=this.#x[e];r&&this.#ot(r.texture,!1,!0,i,t)}#Jt(){this.#St();const e=this.#F[this.#g];e&&this.#ot(e,!0),this.#u=0}#k(e){const i=this.#Zt?!1:e;if(this.#c){this.#c.onVisibility(i);return}this.#t.style.visibility=i?"visible":"hidden"}get#Zt(){return(this.#$!==null||this.#K)&&this.#l?.interlaced!==!1&&this.#Te()}#ot(e,i=!1,t=!0,r=null,n=0){this.#pt(e,i),this.#m={kind:"texture",texture:e,flip:i},this.#k(!0),t&&(this.#G++,this.#et(r,n))}#ei(e,i){this.#H!==0&&!i&&(this.#w.missed+=Math.max(0,e-this.#H-1)),this.#H=e}#ti(e){const i=e-this.#Ue;if(i<re)return;const t=this.#Te()&&(this.#M||this.#D==="film")?this.#ge:this.#X,r={...this.#w,dropped:this.#e.getVideoPlaybackQuality?.().droppedVideoFrames??0,fps:t*1e3/i,frameMs:this.#X===0?0:(this.#ve+this.#Ee)/this.#X,maxQueuedFields:this.#te,mode:this.#D,match:this.#he,combScore:this.#Ge,outputFps:this.#G*1e3/i,duplicateScore:this.#ze,duplicateRunnerUp:this.#qe};this.dispatchEvent(new CustomEvent("stats",{detail:r})),this.#Ye?.(r),this.#Ue=e,this.#X=0,this.#ve=0,this.#ge=0,this.#Ee=0,this.#te=0,this.#G=0}#St(){const e=this.#i;this.#g=(this.#g+1)%x,e.bindTexture(e.TEXTURE_2D,this.#F[this.#g]??null),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,this.#_e),this.#u=Math.min(this.#u+1,x)}#xe(e,i,t,r=!0,n=Number.NaN){if(this.#u===0||this.#R)return null;let s=null;r&&(this.#u===x&&!e?this.#w.filtered++:this.#w.degraded++,s=this.#mt(e?"yadif-flush":i?"yadif-second":"yadif-first",n,i));const a=this.#i,o=this.#g,m=(this.#g+x-1)%x,l=(this.#g+1)%x;let d,c,h;this.#u===1?d=c=h=o:e?(d=m,c=h=o):this.#u===2?(d=c=m,h=o):(d=l,c=m,h=o),a.bindFramebuffer(a.FRAMEBUFFER,t),a.useProgram(this.#y);for(const[p,E]of[d,c,h].entries())a.activeTexture(a.TEXTURE0+p),a.bindTexture(a.TEXTURE_2D,this.#F[E]??null);a.uniform1i(this.#o.prev,0),a.uniform1i(this.#o.cur,1),a.uniform1i(this.#o.next,2),a.uniform2i(this.#o.size,this.#f,this.#p);const f=this.#Le?0:1;return a.uniform1i(this.#o.parity,i?1-f:f),a.uniform1i(this.#o.tff,this.#Le?1:0),a.uniform1i(this.#o.spatialCheck,this.#We?1:0),a.viewport(0,0,this.#f,this.#p),a.drawArrays(a.TRIANGLES,0,3),t===null&&(this.#m={kind:"yadif",flush:e,second:i},this.#k(!0),r&&(this.#G++,this.#et(s,this.#a))),s}#Be(){if(!this.#z)return;const e=this.#e,i=e.videoWidth,t=e.videoHeight;if(i===0||t===0)return;const r=Math.min(e.offsetWidth/i,e.offsetHeight/t),n=i*r,s=t*r;this.#t.style.left=`${e.offsetLeft+(e.offsetWidth-n)/2}px`,this.#t.style.top=`${e.offsetTop+(e.offsetHeight-s)/2}px`,this.#t.style.width=`${n}px`,this.#t.style.height=`${s}px`}#wt(e,i){const t=this.#i;this.#r.width=e,this.#r.height=i,this.#f=e,this.#p=i,this.#u=0,this.#m=null,this.#b(),this.#E(),this.#Be();for(const r of this.#F)t.deleteTexture(r);this.#F=[];for(let r=0;r<x;r++){const n=t.createTexture();t.bindTexture(t.TEXTURE_2D,n),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texImage2D(t.TEXTURE_2D,0,t.RGBA,e,i,0,t.RGBA,t.UNSIGNED_BYTE,null),this.#F.push(n)}this.#se(),this.#lt(),this.#v&&this.#Dt(),(this.#M||this.#v)&&this.#ct()}#Dt(){if(this.#B)return;const e=this.#i,i=e.createTexture();e.bindTexture(e.TEXTURE_2D,i),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,k,A,0,e.RGBA,e.UNSIGNED_BYTE,null);const t=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,t),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,i,0);const r=e.checkFramebufferStatus(e.FRAMEBUFFER)===e.FRAMEBUFFER_COMPLETE;if(e.bindFramebuffer(e.FRAMEBUFFER,null),!r){e.deleteFramebuffer(t),e.deleteTexture(i);return}this.#B={texture:i,framebuffer:t,pixels:new Uint8Array(k*A*4),previousLuma:new Uint8Array(k*A),currentLuma:new Uint8Array(k*A),nextLuma:new Uint8Array(k*A)}}#lt(){this.#B&&(this.#i.deleteFramebuffer(this.#B.framebuffer),this.#i.deleteTexture(this.#B.texture),this.#B=null)}#ct(){const e=this.#i;if(!(this.#x.length===U||this.#f===0)){this.#se();for(let i=0;i<U;i++){const t=e.createTexture();e.bindTexture(e.TEXTURE_2D,t),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,this.#f,this.#p,0,e.RGBA,e.UNSIGNED_BYTE,null);const r=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,r),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,t,0);const n=e.checkFramebufferStatus(e.FRAMEBUFFER)===e.FRAMEBUFFER_COMPLETE;if(e.bindFramebuffer(e.FRAMEBUFFER,null),!n){e.deleteFramebuffer(r),e.deleteTexture(t),this.#se();return}this.#x.push({texture:t,framebuffer:r})}this.#ne=U-1}}#se(){const e=this.#i,i=this.#m?.kind==="texture"?this.#m.texture:null;this.#x.some(t=>t.texture===i)&&(this.#m=null);for(const{texture:t,framebuffer:r}of this.#x)e.deleteFramebuffer(r),e.deleteTexture(t);this.#x=[],this.#n.length=0}#ii(){if(this.#z)return;const e=this.#e.parentElement;if(!e)return;const i=document.createElement("div");i.style.cssText="position:relative;display:inline-block;line-height:0;max-width:100%",e.insertBefore(i,this.#e),i.appendChild(this.#e),i.appendChild(this.#t),this.#z=i,this.#Oe?.observe(this.#e),this.#Be()}#si(){if(this.#c)return;const e=this.#z;this.#z=null,this.#Oe?.disconnect(),this.#t.remove(),e?.parentElement&&(e.parentElement.insertBefore(this.#e,e),e.remove())}#Ct=()=>this.#Be();#ut(e){return!this.#h||this.#s==="main"?!1:(this.#h.postMessage({type:"event",name:e,video:this.#st()}),!0)}#_t=()=>{if(this.#E(),this.#ke=Number.NaN,this.#ut("emptied")){this.#_(),this.#k(!1);return}this.#u=0,this.#oe=0,this.#n.length=0,this.#a=0,this.#Pt(),this.#b(),this.#m=null,this.#k(!1)};#Pt(){this.#w={filtered:0,missed:0,degraded:0,discontinuities:0,late:0,queueResetted:0},this.#H=0,this.#Ue=0,this.#Je=0,this.#X=0,this.#ve=0,this.#ge=0,this.#Ee=0,this.#te=0,this.#G=0,this.#b()}#b(){this.#n.length=0,this.#D="video",this.#he="c",this.#Ge=0,this.#He=!0,this.#Xe.reset(),this.#ze=1/0,this.#qe=1/0}#Ut=()=>{if(this.#E(),this.#ut("seeking")){this.#_();return}this.#le=!1};#P=e=>{if(this.#E(),(e.type==="pause"||e.type==="ended"||e.type==="seeked"||e.type==="ratechange")&&this.#ut(e.type)){this.#_();return}if(e.type==="seeked"){const t=this.#le;if(this.#le=!1,t)return;this.#u=0,this.#b(),this.#m=null,this.#k(!1);return}const i=e.type==="ratechange";if(i&&(this.#a=0,this.#oe=this.#e.currentTime),this.#n.length=0,this.#d&&this.#u>0){const t=this.#nt(),r=t===null?void 0:this.#x[t];if(t!==null&&r){this.#ne=t;const n=this.#xe(!0,!1,r.framebuffer,!0,this.#e.currentTime);this.#At(t,n,this.#a)}else this.#xe(!0,!1,null,!0,this.#e.currentTime)}i&&(this.#u=0,this.#b())};#Lt=e=>{if(e.preventDefault(),this.#c){this.#c.onFailure("the deinterlacer WebGL context was lost");return}this.#s!=="active"&&(this.#R=!0,this.stop())}}function Se(u,e,i,t,r,n,s){return new Ae(u,i,{canvas:e,onFailure:t,onVisibility:r,requestAnimationFrame:n,cancelAnimationFrame:s})}function H(u,e){const i=u.createProgram(),t=ae(u,u.VERTEX_SHADER,Fe),r=ae(u,u.FRAGMENT_SHADER,e);if(u.attachShader(i,t),u.attachShader(i,r),u.linkProgram(i),u.deleteShader(t),u.deleteShader(r),!u.getProgramParameter(i,u.LINK_STATUS)){const n=u.getProgramInfoLog(i);throw u.deleteProgram(i),new Error(`the deinterlacer failed to link: ${n??"no reason given"}`)}return i}function ae(u,e,i){const t=u.createShader(e);if(!t)throw new Error("the deinterlacer could not create a shader");if(u.shaderSource(t,i),u.compileShader(t),!u.getShaderParameter(t,u.COMPILE_STATUS)){const r=u.getShaderInfoLog(t);throw u.deleteShader(t),new Error(`the deinterlacer failed to compile: ${r??"no reason given"}`)}return t}const N=self;class we extends EventTarget{currentTime=0;playbackRate=1;seeking=!1;paused=!0;ended=!1;readyState=0;videoWidth=0;videoHeight=0;parentElement=null;offsetWidth=0;offsetHeight=0;offsetLeft=0;offsetTop=0;#r=[];update(e){this.currentTime=e.currentTime,this.playbackRate=e.playbackRate,this.seeking=e.seeking,this.paused=e.paused,this.ended=e.ended,this.readyState=e.readyState,this.videoWidth=e.videoWidth,this.videoHeight=e.videoHeight,this.#r=e.buffered}get buffered(){return{length:this.#r.length,start:e=>{const i=this.#r[e];if(!i)throw new DOMException("Invalid range index","IndexSizeError");return i.start},end:e=>{const i=this.#r[e];if(!i)throw new DOMException("Invalid range index","IndexSizeError");return i.end}}}getVideoPlaybackQuality(){return{creationTime:performance.now(),droppedVideoFrames:0,totalVideoFrames:0,corruptedVideoFrames:0}}requestVideoFrameCallback(){return 0}cancelVideoFrameCallback(){}}let C=null,F=null,B=!1,Y=null,he=Promise.resolve(),V=null,j=null,oe=null;function De(u,e,i){he=he.then(async()=>{const t=Y;if(!t){u.close();return}const r=Number.isFinite(u.timestamp)?Number(u.timestamp):Number(e.mediaTimestampUs);oe!==e.generation&&(oe=e.generation,V=null,j=null),(V===null||j===null)&&(V=performance.now(),j=r);const n=V+(r-j)/1e3,s=Math.max(0,n-performance.now());s>0&&await new Promise(a=>setTimeout(a,s));try{await t.write(u)}catch{try{u.close()}catch{}}i&&M({type:"queuedMeta",meta:e})}).catch(()=>{})}function Ce(u){return N.requestAnimationFrame(u)}function _e(u){N.cancelAnimationFrame(u)}function M(u,e=[]){N.postMessage(u,e)}function Pe(u,e){u.doubleRate=e.doubleRate,u.autoFilm=e.autoFilm,u.filmCombThreshold=e.filmCombThreshold}N.onmessage=u=>{const e=u.data;try{if(e.type==="initialize"){if(typeof N.requestAnimationFrame!="function")throw new Error("requestAnimationFrame is unavailable in this Worker");Y=e.queuedFrameSink?e.queuedFrameSink.getWriter():null,C=new we,C.update(e.video);const i=e.options.diagnostic||e.options.capturePresentedFrames||e.options.captureQueuedFrames||e.options.captureQueuedFrameFullSize||e.options.capturePresentationQueue?{onFilteredPicture:e.options.diagnostic?t=>{B||M({type:"diagnostic",meta:t})}:void 0,onPresentedFrame:e.options.capturePresentedFrames?(t,r)=>{if(B){t.close();return}try{M({type:"presented",frame:t,meta:r},[t])}catch{t.close()}}:void 0,onQueuedFrame:e.options.captureQueuedFrames||Y?(t,r)=>{if(B){t.close();return}if(Y){De(t,r,e.options.captureQueuedMeta);return}try{M({type:"queued",frame:t,meta:r},[t])}catch{t.close()}}:void 0,onPresentationQueue:e.options.capturePresentationQueue?t=>{B||M({type:"presentationQueue",meta:t})}:void 0}:void 0;F=Se(C,e.canvas,{...e.options,diagnostic:{...i,bypassDisplayQueue:e.options.bypassDisplayQueue,captureQueuedFrameFullSize:e.options.captureQueuedFrameFullSize}},t=>{B||M({type:"failed",message:t})},t=>M({type:"visibility",visible:t}),Ce,_e),F.addEventListener("stats",t=>{const{dropped:r,...n}=t.detail;M({type:"stats",stats:n})}),F.scan=e.scan,F.videoTimeline=e.videoTimeline,F.enabled=e.enabled,M({type:"ready"});return}if(!C||!F)return;switch(e.type){case"frame":C.update(e.video);try{F.ingestExternalFrame(performance.now(),e.metadata,e.frame)}finally{e.frame.close(),M({type:"consumed",id:e.id})}break;case"settings":Pe(F,e.options);break;case"scan":F.scan=e.scan;break;case"timeline":F.videoTimeline=e.videoTimeline;break;case"enabled":F.enabled=e.enabled;break;case"event":C.update(e.video),C.dispatchEvent(new Event(e.name));break;case"capture":C.videoWidth=e.width,C.videoHeight=e.height,F.capture().then(i=>M({type:"capture",id:e.id,image:i},[i])).catch(()=>M({type:"capture",id:e.id,image:null}));break;case"destroy":B=!0,F.destroy(),F=null,C=null,N.close();break}}catch(i){const t=i instanceof Error?i.message:String(i);M({type:"failed",message:t})}}})();
//# sourceMappingURL=worker-foOnRHTu.js.map
