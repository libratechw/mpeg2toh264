 ...
 */
export declare const EXPECTED_DISPLAY_TIME_TOLERANCE_MS = 1000;
/**
 ...
 */
export declare function usableExpectedDisplayTime(expected: unknown, now: number): number;
/**
 ...
 */
export declare function loopWindowFor(canvas: HTMLCanvasElement): Window;
/**
 ...
 */
export declare function captureSize(videoWidth: number, videoHeight: number, codedWidth: number, codedHeight: number): {
    width: number;
    height: number;
};
