...
type EngineRenderTraceInput =
  ...
  | Omit<Extract<EngineRenderTraceEvent, { kind: "worker-bridge" }>, "sequence">
  | Omit<Extract<EngineRenderTraceEvent, { kind: "worker-frame" }>, "sequence">
  | Omit<Extract<EngineRenderTraceEvent, { kind: "page-raf" }>, "sequence">
  | Omit<
